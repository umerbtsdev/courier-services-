        ...
        <div class="row custom-container-wrap">
            <div class="col-md-12">
                ...
                <span>
                    ...
                    <h1 class="float-left"><strong> Load Sheet List</strong></h1>
                </span>
                    <h1>
            ...
            <div class="col-md-12 custom-table-styles">
                <?php
                echo GridRender::setGridId("Loadsheetlist")
                    ->enableFilterToolbar()
                    ->setGridOption('url',URL::to('/loadsheetlist-grid-data'))
                    ...
                    ->addColumn(array('label'=>'Status','index'=>'action','width'=>200,'search'=>false,'exhidden'=>true))
                    ->addColumn(array('index'=>'Loadsheet No', 'index'=>'loadsheet_no','search'=>true, 'width'=>200))
                    ->addColumn(array('index'=>'Created At', 'index'=>'created_at','search'=>true, 'width'=>200))

    ...
    <div class="row custom-container-wrap">
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                <span>
                    <h1><strong> All Parts </strong></h1>
                </span>
                @if(App\Helper\Common::userwisepermission(Auth::user()->id, "Parts Create"))
                <h1>
                    <a onclick="editmaintenancerequest('{{ url('workshops/parts/add') }}','create')" class = "custom-btn-action custom-btn-view bgcolr-orange"> Add Part</a>
                </h1>
                @endif
            </div>
            ...
            <div class="col-md-12 custom-table-styles wrap-scroll" style="overflow: auto;">
                <?php
                    echo GridRender::setGridId("ManufacturerList")
                        ->enableFilterToolbar()
                        ->setGridOption('url',URL::to('workshops/parts/fetch-grid'))
                        ...
                        ->addColumn(array('label'=>'Manufacturer','index'=>'manufacturers_name','width'=>200,'search'=>true))
                        ->addColumn(array('label'=>'Part Name','index'=>'name','width'=>200,'search'=>true))

    ...
    <div class="row custom-container-wrap">
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                <h1>
                @if(App\Helper\Common::userwisepermission(Auth::user()->id, "Vehicle Leasing Create"))
                    <a onclick="editmaintenancerequest('{{ url('/Finance/Vehicle-Leasing/add') }}','create')" class = "custom-btn-action custom-btn-view bgcolr-orange">Add Lease</a>
                @endif
                </h1>
            </div>

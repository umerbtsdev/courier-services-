...
<div class="bgcolr-grey">
    ...
    <div class="box-body">
        ...
        {!! Form::open(array('url'=>'/Finance/Vehicle-Leasing/add','method'=>'POST','id'=>'workshop-form', 'files' => false)) !!}
            <div class="form-group col-md-4">
                ...
                <select id="vehicles" name="vehicle" class="form-control" required>
                    ...
                    @foreach ($vehicles as $vehicle)
                        <option value="{{ $vehicle->id }}" data-Lease="{{  $vehicle->lease_amount != 0 ? $vehicle->lease_amount:'0' }}">{{ $vehicle->vehicle_no }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
                ...
                {!! Form::date("date_paid", date('Y-m-d'), ["class"=>"form-control","id"=>"lease_amount_paid"]) !!}

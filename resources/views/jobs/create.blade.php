...
<div class = 'container-fluid'>
        ...
        {!! Form::open(array('url'=>'/workshops/job/save','method'=>'POST','id'=>'purchase-order-form', 'class'=>"form-inline", 'autocomplete' => "off")) !!}
        <div class="col-md-12" style="padding:0; margin-bottom:4%;">
            <div class="col-md-10">
                <div class="form-group col-sm-4">
                    <label for="job_date" class="control-label required">Date </label>
                    {!! Form::date("job_date", date("Y-m-d"), ["id"=>"job_date", "class"=>"form-control ", "required"=>true]) !!}
                </div>

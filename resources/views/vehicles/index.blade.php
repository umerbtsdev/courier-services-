    ...
    <div class="row custom-container-wrap">
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                ...
                <h1>
                @if(App\Helper\Common::userwisepermission(Auth::user()->id, "Vehicles Create"))
                    <a onclick="editmaintenancerequest('{{ url('vehicles/create') }}')" class = "custom-btn-action custom-btn-view bgcolr-orange"> Add Vehicles</a>
                @endif

    ...
    <div class="row custom-container-wrap">
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                <span>
                    ...
                    <h1><strong> All Routes</strong></h1>
                </span>
                <h1>
                @if(App\Helper\Common::userwisepermission(Auth::user()->id, "Route Create"))
                    <a onclick="editmaintenancerequest('{{ url('/route/create') }}')" class = "custom-btn-action custom-btn-view bgcolr-orange"> Add Route </a>
                @endif

            {{--    <button type="button" class="btn btn-default"   
                onclick="editmaintenancerequest('{{ url('ci/edit/3') }}')">
        ...
        <div class="custom-inner-container-wrap">
            <div class="col-md-12 custom-table-styles">
                <?php
                        echo GridRender::setGridId("RouteList")
                            ->enableFilterToolbar()
                            ->setGridOption('url',URL::to('/route-grid-data'))
                            ...
                            ->addColumn(array('label'=>'ID', 'index'=>'id','search'=>true, 'width'=>200))
                            ->addColumn(array('label'=>'Name','index'=>'name','search'=>true,'width'=>650,'exhidden'=>true))

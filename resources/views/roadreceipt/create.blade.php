<div class = 'container-fluid'>
    ...
    <form action="{{url('roadreceipt/save')}}" id='purchase-order-form' method = "post"  autocomplete="off">
        {!! csrf_field() !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="col-md-4">
                                    <label>Date:</label>
                                    <input type="date" id="rr_date" class="rr_date form-control item_co de" name="rr_date"  value="">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <table id="routeList" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-2">
                                                    <input type="text" class="form-control income_description" name="income_description[]" id="income_description" value="" placeholder="Enter Description">
                                                </td>

                                                <td class="col-md-1">
                                                    <input type="text" class="form-control income_amount textrequired" name="income_amount[]" id="income_amount" value="" placeholder="Enter Amount">
                                                </td>
                                                <td class="col-md-2">
...
<script>
  ...
  jQuery("table").on("click",".addbutton", function(){
    ...
    jQuery(".rr_link").click(function(){
        ...
        var selected_value = jQuery("#trip_id").val();
        jQuery.ajax({

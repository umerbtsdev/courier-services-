            ...
            <div class="page-heading-primary">
                ...
                <h1>
                    @if(App\Helper\Common::userwisepermission(Auth::user()->id, "Customer Create"))
                        <a onclick="editmaintenancerequest('{{ url('/setup/countries/create') }}')" class="float-right btn-cus-dessign btn btn-primary waves-effect waves-light"> Add Countries </a>
                    @endif

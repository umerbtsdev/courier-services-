...
<div class="bgcolr-grey">
     @if(Request::session()->has('user_create_status'))
      ...
      @endif   
     @endif
     {!! Form::open(array('url'=>'/project-management/projects/add','method'=>'POST','id'=>'project-form', 'class'=>"form-horizontal", 'files' => false)) !!}
        <div class="box-body">
            <div class="col-sm-10">
                <div class="form-group col-sm-12">
                    <label for="project_name" class="control-label col-sm-3">Project Name:</label>
                    <div class="col-sm-8">
                       {!! Form::text("project_name", null, ["class"=>"form-control","name"=>"project_name", "id"=> "project_name","pattern"=>".{3,}","required"=>true, "title"=> "please Enter Project Name with 3 characters minimum"]) !!}
                    </div>
                </div>
        ...
        <div class="box-footer">
            <div class="col-md-12" style="">
                <button style="float:right" class = "custom-btn-action custom-btn-view bgcolr-orange no-margin" type="submit">Add Project</button>
            </div>
        </div>
    {!! Form::close() !!}
</div>

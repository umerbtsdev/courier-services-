        ...
        <div class="custom-inner-container-wrap">
            <div class="col-md-12 custom-table-styles">
                ...
                echo GridRender::setGridId("ProductListView")
                    ->enableFilterToolbar()
                    ->setGridOption('url',URL::to('/product-reject-data'))
                    ...
                    ->addColumn(array('label'=>'Created at','index'=>'created_at', 'sorttype'=>'date','searchoptions'=>array('dataInit'=>'function (element) {$(element).daterangepicker({ autoUpdateInput: false});}')))
                    ->addColumn(array('label'=>'Updated at','index'=>'updated_at','sorttype'=>'date','searchoptions'=>array('dataInit'=>'function (element) {$(element).daterangepicker({ autoUpdateInput: false});}')))
                    ->renderGrid()
                ?>
            </div>
        </div>

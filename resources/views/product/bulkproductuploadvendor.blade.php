...
@section('content')
                        ...
                        <div class="form-group csvUploadField" >
                            <div class="">
                                <div class="col-md-7" style="background: #f3f3f3;">
                                    {!! Form::open(array('url'=>'product/bulkproductvendorSubmit','method'=>'POST','id'=>'bluk_product_form', 'files'=>true)) !!}
                                    <div class="col-md-6 no-padding csv-wrap" style="height: 180px;">
                                        <div class="col-md-3 bulk-img-wrap no-padding">
                                            <img src="{{ url('img/custom')}}/icon-csv-lg.png">
                                        </div>

                                        <div class="col-md-9 no-padding">
                                            <h3 class="sub-heading"> Upload Product CSV </h3>
                                            <p class="help-block uploaded-file-name" style="clear: both; display: block;">Max 500 rows per CSV</p>
                                ...
                                <div class="col-md-5" style="background: #fff;">
                                    <div class="col-md-3 bulk-img-wrap no-padding" style="height: 180px;">
                                        <img src="{{ url('img/custom')}}/icon-download-lg.png">
                                    </div>
                                    <div class="col-md-9 no-padding">
                                        <div class="form-group <?php echo e($errors->has('parent_id') ? 'has-error' : ''); ?>">
                                            {!! Form::open(array('url'=>'/product/vendordatawithvalue','method'=>'POST','id'=>'bluk_product_csv', 'files'=>true)) !!}
                                            <div class="row">
                                                <h3 class="sub-heading"> Export CSV for product update</h3>
                                                <select id="categories" class="chosen-select form-control selectrequired" name="category">
                                            ...
                                            <div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <h3 class="sub-heading"> Start Date</h3>
                                                        <input type="date" class="form-control startDate" name="startDate" id="startDate" aria-describedby="Help" value="" placeholder="Enter Start Date" maxlength="255">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h3 class="sub-heading"> End Date</h3>
                                                        <input type="date" class="form-control endDate" name="endDate" id="endDate" aria-describedby="Help" value="" placeholder="Enter End Date" maxlength="255">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-12 no-padding">
                                        <input type="submit" class="btn btn-primary csv_download_button bgcolr-aqua" value="Export products" style="width: 100%; padding: 20px; font-size: 20px; text-transform: uppercase; margin-bottom: 15px;"></input>
                                    </div>
                                    {!! Form::close() !!}
                                </div>
                            </div>
    ...
    <script>
        jQuery(document).ready(function(){
            ...
            },"File Size is Exceed from 900MB ");

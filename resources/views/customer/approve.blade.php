	...
	<div class="bgcolr-grey">
	     ...
	     @endif
		<div class="box-body">
			<form action="{{url('customer/approve-data/'.$customer->id)}}" method = "post"  autocomplete="off">
				{!! csrf_field() !!}
				<div class="row">
				...
				<div class="row" >
					...
					<div class="form-group col-md-4">
						...
						<input type="text" name="cnic" id="cnic" value="{{$customer->cnic}}" readonly="readonly" class = "form-control" placeholder = "Cnic" required="true">
					</div>
					<div class="form-group col-md-4">
						<label for="">Bank</label>
						<input type="text" name="bank_name" id="bank_name" value="{{$customer->bank_name}}" readonly="readonly" class = "form-control" placeholder = "Bank" required="true">
					</div>
				</div>
				<div class="row" >
					...
					<div class="form-group col-md-4">
						...
						<input type="text" name="branch_name" id="branch_name" value="{{$customer->branch_name}}" readonly="readonly" class = "form-control" placeholder = "Branch" required="true">
					</div><div class="form-group col-md-4">
						<label for="">Account #</label>
						<input type="text" name="account_no" id="account_no" value="{{$customer->account_no}}" readonly="readonly" class = "form-control" placeholder = "account no" required="true">
					</div>
				<div class="form-group col-md-4">
					<label for="">Account Title</label>
					<input type="text" name="account_title" id="account_title" value="{{$customer->account_title}}" readonly="readonly" class = "form-control" placeholder = "Account Title" required="true">
				</div>
					<div class="form-group col-md-4">
						<label for="">Birth Date</label>
						<input type="date" name="brith_date" id="brith_date"  value="{{$customer->brith_date}}" readonly="readonly" class = "form-control" placeholder = "date of birth" required="true">
					</div>
					<div class="form-group col-md-4">
						<label for="">Anniversary Date</label>
						<input type="date" name="anniversary_date"  value="{{$customer->anniversary_date}}" readonly="readonly" id="anniversary_date" class = "form-control" placeholder = "Phone No" required="true">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-md-12">
						<label for="">Address</label>
						<input type="text" name="address" id="address"  value="{{$customer->address}}" readonly="readonly" class = "form-control" placeholder = "Address" required="true">
					</div>
				</div>

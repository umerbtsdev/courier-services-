...
<head>
    ...
    <link href="{{url('css/custom_navi.css')}}" rel="stylesheet">

{{--<link href="{{url('public/css/custom.rj.css')}}" rel="stylesheet">--}}
...
@include('adminlte::layouts.partials.sidemenu')
<!-- jQuery 3 -->
    ...
    <script type="text/javascript" src="{{url("js/productmodule.js")}}"></script>

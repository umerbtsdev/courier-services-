        ...
        <div id="headerwrap">
            <div class="container">
                <div class="row centered">
                    ...
                    <div class="col-lg-8">
                        <img class="img-responsive" src="{{ asset('/public/img/app-bg.png') }}" alt="">
                    </div>
                    <div class="col-lg-2">
                        <br>
                        <img class="hidden-xs hidden-sm hidden-md" src="{{ asset('/public/img/arrow2.png') }}">
        ...
        <div id="intro">
            <div class="container">
                <div class="row centered">
                    ...
                    <br>
                    <div class="col-lg-4">
                        <img src="{{ asset('/public/img/intro01.png') }}" alt="">
                    ...
                    <div class="col-lg-4">
                        <img src="{{ asset('/public/img/intro02.png') }}" alt="">
                        <h3>{{ trans('adminlte_lang::message.schedule') }}</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                    <div class="col-lg-4">
                        <img src="{{ asset('/public/img/intro03.png') }}" alt="">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 centered">
                        <img class="centered" src="{{ asset('/public/img/mobile.png') }}" alt="">
                    </div>
                        ...
                        <div id="carousel-example-generic" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="{{ asset('/public/img/item-01.png') }}" alt="">
                                </div>
                                <div class="item">
                                    <img src="{{ asset('/public/img/item-02.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="{{ url ('/public/js/app-landing.js') }}"></script>
<script>
    $('.carousel').carousel({
        interval: 3500
    })

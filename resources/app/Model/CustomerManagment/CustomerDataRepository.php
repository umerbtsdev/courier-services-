...
class CustomerDataRepository extends EloquentRepositoryAbstract {
    ...
    {
        $customer = Customer::select('business_name', 'owner_name','email', 'contact_no','alernate_no','country_id','city_id','address','user_id', 'cnic', 'bank_name','branch_name','account_no','account_title','brith_date','anniversary_date');
    ...
    public function getRows($limit, $offset, $orderBy = null, $sord = null, array $filters = array(),$nodeId = null, $nodeLevel = null,$exporting)
    {
        ...
        if(!empty($customer)){
            ...
            foreach($customer as $cus) {
                $rolesColumn    = '';
                $actionColumn   = "";
                $actionUrl = url("customer/edit/".$cus->id);
                $actionUrlDel = url("customer/delete/".$cus->id);
               
                if(Common::userwisepermission(Auth::user()->id, "Customer Update")){
                ...
                if(Common::userwisepermission(Auth::user()->id, "Customer Cancel")){

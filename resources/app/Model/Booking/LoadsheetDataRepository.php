...
class LoadsheetDataRepository extends EloquentRepositoryAbstract {
    ...
    public function getTotalNumberOfRows(array $filters = array())
    {
        ...
        $countries = OrderBooking::leftjoin('customer', 'customer.id','=','order_booking.consignee_id')
            ...
            ->where('loadsheet_no','=','0');
        if($customer != null)
        {
            $countries->where('customer.id','=', $customer->id);
        }
    ...
    public function getRows($limit, $offset, $orderBy = null, $sord = null, array $filters = array(),$nodeId = null, $nodeLevel = null,$exporting)
    {
        ...
        if(!empty($countries)){
            ...
            foreach($countries as $country) {
                ...
                $actionUrlDel = url("transaction/orderbooking/delete/".$country->id);
                ...
                //if (Common::userwisepermission(Auth::user()->id, "Cities Cancel")) {
                    $deleteBtn = "<a onclick=editmaintenancerequest('".$actionUrlDel."') class=' btn-cus-dessign btn btn-primary waves-effect waves-light'>Delete</a>";
                //}
                //else{
                //    $deleteBtn = "";
                //}

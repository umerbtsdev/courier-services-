...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        return redirect('login')->withErrors(['Customer Registration Message:', 'Dear customer your request for account opening has been successfully submitted and we will revert back to u shortly with all necessary details']);;

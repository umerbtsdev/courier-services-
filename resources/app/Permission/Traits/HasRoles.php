...
use App\Permission\Contracts\Permission;
use App\Permission\Contracts\Role;
...
trait HasRoles
{
    ...
    {
        $this->roles()->detach($this->getStoredRolebyId($role));
    ...
    public function hasRole($roles)
    {
        ...
        return true; //(bool) $roles->intersect($this->roles)->count();
    }
    ...
    protected function getStoredRolebyId($role)
    {
        ...
        //if (is_string($role)) {
        //    return app(Role::class)->findByRoleId($role);
        //}
        $role = static::where('id', $role)->first();

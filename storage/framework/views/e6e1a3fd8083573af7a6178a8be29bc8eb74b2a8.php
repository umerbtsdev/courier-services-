        ...
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                <span>
                    ...
                    <h1 class="float-left"><strong> Customer List</strong></h1>
                </span>
                <h1>
                    <?php if(App\Helper\Common::userwisepermission(Auth::user()->id, "Customer Create")): ?>
                        <a onclick="editmaintenancerequest('<?php echo e(url('/customer/create')); ?>')" class = "float-right btn-cus-dessign btn btn-primary waves-effect waves-light"> Add Customer </a>
                    <?php endif; ?>
            ...
            <div class="col-md-12 custom-table-styles">
                <?php
                        echo GridRender::setGridId("AlertList")
                            ->enableFilterToolbar()
                            ->setGridOption('url',URL::to('/customer-grid-data'))

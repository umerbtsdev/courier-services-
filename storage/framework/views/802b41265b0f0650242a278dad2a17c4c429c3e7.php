    ...
    <div class="row custom-container-wrap">
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                ...
                <h1> 
                    <?php if(App\Helper\Common::userwisepermission(Auth::user()->id, "Trips Create")): ?>
                        <a onclick="editmaintenancerequest('<?php echo e(url('trip/create')); ?>')" class = "custom-btn-action custom-btn-view bgcolr-orange"> Add Trip</a>
                    <?php endif; ?>

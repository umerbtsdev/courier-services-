        ...
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                ...
                <?php if(App\Helper\Common::userwisepermission(Auth::user()->id, "Expense Payment Create")): ?>
                    <a onclick="editmaintenancerequest('<?php echo e(url('/Finance/Invoice-Amount-Receivable/add')); ?>','create')" class = "custom-btn-action custom-btn-view bgcolr-orange">Make  Invoice Receivable Payment</a>
                <?php endif; ?>
                </h1>
            </div>
            ...
            <div class="col-md-12 custom-table-styles wrap-scroll" style="overflow: auto;">
                <?php
                        echo GridRender::setGridId("expense-payment-grid")
                            ->enableFilterToolbar()
                            ->setGridOption('url',URL::to('/invoice-amount-receivable-grid'))
                            ...
                            ->addColumn(array('label'=>'Total Amount', 'index'=>'total_paid','search'=>false, 'width'=>200))
                            ->addColumn(array('label'=>'Date Paid', 'index'=>'paid_date','search'=>false, 'width'=>150))
                            ->addColumn(array('label'=>'Created By', 'index'=>'invoice_receivable_created_by','search'=>false, 'width'=>150))
                            ...
                            ->addColumn(array('label'=>'Updated At', 'index'=>'invoice_receivable_updated_by','search'=>false, 'width'=>150))
    ...
    function editmaintenancerequest(url,typed){
        ...
        jQuery.ajax({
            ...
            success: function(result){
                ...
                if(typed == 'edit'){
                    title = 'Edit Invoice Receivable Payment';
                }
                else if(typed =='create'){
                    title = "Make Invoice Receivable Payment";
                }
                else if(typed == 'cancel')
                {
                    title = 'Delete Invoice Receivable Paymentt';

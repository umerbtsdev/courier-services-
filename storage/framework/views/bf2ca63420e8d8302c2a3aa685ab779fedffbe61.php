            ...
            <div class="page-heading-primary">
                ...
                <h1>
                    <?php if(App\Helper\Common::userwisepermission(Auth::user()->id, "Customer Create")): ?>
                        <a onclick="editmaintenancerequest('<?php echo e(url('/setup/city/create')); ?>')" class="float-right btn-cus-dessign btn btn-primary waves-effect waves-light"> Add Cites </a>
                    <?php endif; ?>

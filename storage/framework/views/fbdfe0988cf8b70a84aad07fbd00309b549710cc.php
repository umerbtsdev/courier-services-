    ...
    <div class="row custom-container-wrap">
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                <h1>
                <?php if(App\Helper\Common::userwisepermission(Auth::user()->id, "Vehicle Leasing Create")): ?>
                    <a onclick="editmaintenancerequest('<?php echo e(url('/Finance/Vehicle-Leasing/add')); ?>','create')" class = "custom-btn-action custom-btn-view bgcolr-orange">Add Lease</a>
                <?php endif; ?>
                </h1>
            </div>
      ...
      <div class="custom-inner-container-wrap">
            <div class="col-md-12 custom-table-styles wrap-scroll" style="overflow: auto;">
                <?php
                        echo GridRender::setGridId("VehicleLeaseGrid")
                            ->enableFilterToolbar()
                            ->setGridOption('url',URL::to('/vehicles-leasing-grid'))
                            ...
                            ->addColumn(array('label'=>'Amount', 'index'=>'paid_amount','search'=>true, 'width'=>200))
                            ->addColumn(array('label'=>'Date Paid', 'index'=>'paid_date','search'=>true, 'width'=>150))

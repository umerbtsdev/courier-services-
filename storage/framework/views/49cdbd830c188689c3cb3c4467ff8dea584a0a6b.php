<div class = 'container-fluid'>
    ...
    <form action="<?php echo e(url('trip/save')); ?>" id='purchase-order-form' method = "post"  autocomplete="off">
        <?php echo csrf_field(); ?>
                          ...
                          <div class="col-md-4">
                              ...
                              <select class="form-control item selectrequired" class="form-control" name="vehicle_id" id="vehicle_id" >
                                  ...
                                  <?php $__currentLoopData = $Vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($Vehicle->id); ?>" rel="<?php echo e($Vehicle->brand_name); ?>,<?php echo e($Vehicle->driver_name); ?>,<?php echo e($Vehicle->reading_end); ?>"><?php echo e($Vehicle->vehicle_no); ?></option>
                                ...
                                <tr>
                                    <td class="col-md-2">
                                        ...
                                        <select class="form-control route_from selectrequired" name="route_from[]" id="route_from[]" >
                                            ...
                                            <?php $__currentLoopData = $Routs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Rout): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($Rout->id); ?>"><?php echo e($Rout->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    ...
                                    <td>
                                        <button class="btnSubmit addbutton" style="padding: 0px; border: 0px; border-radius: 10px;" type="button"><img class="fa-plus-circle" src="<?php echo e(asset('images/Add.png')); ?>" style="width: 22px;" /> </button>
                                        <button style="padding: 0px; border: 0px; border-radius: 10px;" class="btnSubmit removebutton" type="button"><img class="fa-plus-circle" src="<?php echo e(asset('images/remove.jpg')); ?>" style="width: 22px;" /></button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                              ...
                              <tr>
                                  <td class="col-md-2">
                                      ...
                                      <select class="form-control fuel_station_id selectrequired" class="form-control" name="fuel_station_id[]" id="fuel_station_id[]" >
                                          ...
                                          <?php $__currentLoopData = $fuelstations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fuelstation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <option value="<?php echo e($fuelstation->id); ?>"><?php echo e($fuelstation->name); ?></option>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
...
<script>
  ...
  jQuery("#roadreceipt_id").change(function(){
    ...
    jQuery(".rr_trip").click(function(){
        ...
        jQuery.ajax({
            url: "<?php echo e(url('roadreceipt-data')); ?>",
            type: "post",
            data: {
  ...
  jQuery("table").on("click",".addbutton", function(){
   ...
   $('#VehicleID').change(function() {
                  $.ajax({
                     url: "<?php echo e(url(Request::path().'/get_vehicles')); ?>",
                      type: "POST",

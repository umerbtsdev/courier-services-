	...
	<div class="bgcolr-grey">
	     ...
	     <?php endif; ?>
		<div class="box-body">
			<form action="<?php echo e(url('customer/disable-data/'.$customer->id)); ?>" method = "post"  autocomplete="off">
				<?php echo csrf_field(); ?>
				...
				<div class="row" >
					...
					<div class="form-group col-md-4">
						...
						<input type="text" name="cnic" id="cnic" readonly="readonly" value="<?php echo e($customer->cnic); ?>" class = "form-control" placeholder = "Cnic" required="true">
					</div>
					<div class="form-group col-md-4">
						<label for="">Bank</label>
						<input type="text" name="bank_name" id="bank_name" readonly="readonly" value="<?php echo e($customer->bank_name); ?>" class = "form-control" placeholder = "Bank" required="true">
					</div>
				</div>
				<div class="row" >
					...
					<div class="form-group col-md-4">
						...
						<input type="text" name="branch_name" id="branch_name" readonly="readonly" value="<?php echo e($customer->branch_name); ?>" class = "form-control" placeholder = "Branch" required="true">
					</div><div class="form-group col-md-4">
						<label for="">Account #</label>
						<input type="text" name="account_no" id="account_no" readonly="readonly" value="<?php echo e($customer->account_no); ?>"  class = "form-control" placeholder = "account no" required="true">
					</div>
				<div class="form-group col-md-4">
					<label for="">Account Title</label>
					<input type="text" name="account_title" id="account_title" readonly="readonly" value="<?php echo e($customer->account_title); ?>" class = "form-control" placeholder = "Account Title" required="true">
				</div>
					<div class="form-group col-md-4">
						<label for="">Birth Date</label>
						<input type="date" name="brith_date" id="brith_date" readonly="readonly" value="<?php echo e($customer->brith_date); ?>" class = "form-control" placeholder = "date of birth" required="true">
					</div>
					<div class="form-group col-md-4">
						<label for="">Anniversary Date</label>
						<input type="date" name="anniversary_date" readonly="readonly" value="<?php echo e($customer->anniversary_date); ?>" id="anniversary_date" class = "form-control" placeholder = "Phone No" required="true">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-md-12">
						<label for="">Address</label>
						<input type="text" name="address" id="address" readonly="readonly" value="<?php echo e($customer->address); ?>" class = "form-control" placeholder = "Address" required="true">
					</div>
				</div>

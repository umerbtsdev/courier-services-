...
<div class="bgcolr-grey">
    ...
    <div class="box-body">
        ...
        <?php echo Form::open(array('url'=>'/Finance/Vehicle-Leasing/add','method'=>'POST','id'=>'workshop-form', 'files' => false)); ?>
            ...
            <div class="form-group col-md-4">
                ...
                <select id="vehicles" name="vehicle" class="form-control" required>
                    ...
                    <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($vehicle->id); ?>" data-Lease="<?php echo e($vehicle->lease_amount != 0 ? $vehicle->lease_amount:'0'); ?>"><?php echo e($vehicle->vehicle_no); ?></option>

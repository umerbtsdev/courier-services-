...
<h1 class="float-left"><strong> Cost Center List</strong></h1>
                ...
                <h1>
                    <?php if(App\Helper\Common::userwisepermission(Auth::user()->id, "Cost Center Create")): ?>
                        <a onclick="editmaintenancerequest('<?php echo e(url('setup/costcenter/create')); ?>')" class = "float-right btn-cus-dessign btn btn-primary waves-effect waves-light"> Add Cost Center </a>
                    <?php endif; ?>

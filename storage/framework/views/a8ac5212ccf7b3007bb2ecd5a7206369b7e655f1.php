                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-6 display-inline">
                                ...
                                <input type="text" name="name" <?php echo e((isset($customer->first_name) ? "readonly='readonly'" : "")); ?> value="<?php echo e((isset($customer->first_name) ? $customer->first_name : "") ." ".(isset($customer->last_name) ?  $customer->last_name : "")); ?>" id="name" class = "form-control" placeholder = "Name" disabled="true">
                            </div>
                            ...
                            <div class="row">
                               <div class="form-group col-md-6 display-inline">
                                ...
                                <input type="email" value="<?php echo e((isset($customer->email) ? $customer->email : "" )); ?>" <?php echo e((isset($customer->email) ? "readonly='readonly'" : "" )); ?> name="email" id="email" class="form-control" placeholder="Email" disabled="true">
                            </div>
                            ...
                            <div class="form-group col-md-6 display-inline">
                                ...
                                <select name = "city" id="city" <?php echo e((isset($customer->city_id) ? "readonly='readonly'" : "")); ?> class = "form-control" placeholder="City" disabled="true">
                            ...
                            <div class="form-group col-md-6 display-inline">
                                ...
                                <input type="text" name="contact" value="<?php echo e((isset($customer->contact_no) ? $customer->contact_no : "")); ?>" <?php echo e((isset($customer->contact_no) ? "readonly='readonly'" : "")); ?>  id="contact" class="form-control" placeholder="contact" disabled="true">
                            </div>
                            </div>
                            <div class="row">
                            <div class="form-group col-md-12 display-inline">
                                <label for="">Address</label>
                                <input type="text" name="address" value="<?php echo e((isset($customer->address) ? $customer->address : "")); ?>" <?php echo e((isset($customer->address) ? "readonly='readonly'" : "")); ?> id="address" class="form-control" placeholder="Address" disabled="true">
                            </div>

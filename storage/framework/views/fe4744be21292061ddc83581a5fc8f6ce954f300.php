    ...
    <div class="row custom-container-wrap">
        <div class="col-md-12">
            ...
            <div class="page-heading-primary">
                ...
                <?php if(App\Helper\Common::userwisepermission(Auth::user()->id, "Services Create")): ?>
                <h1>
                    <a onclick="editmaintenancerequest('<?php echo e(url('setup/workshops/services/add')); ?>','create')" class = "float-right btn-cus-dessign btn btn-primary waves-effect waves-light"> Add Service</a>
                </h1>
                <?php endif; ?>
            </div>

...
class CustomerDataRepository extends EloquentRepositoryAbstract {
    ...
    {
        $customer = Customer::select('first_name', 'last_name','email', 'contact_no','alernate_no','country_id','city_id','address','user_id', 'cnic', 'bank_name','branch_name','account_no','account_title','brith_date','anniversary_date');

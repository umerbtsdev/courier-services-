    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        getXmlData: function(a, b, c) {
            ...
            return "function" == typeof
                b ? b(a) : e && e[2] ? e[1] ? $(e[1], a).attr(e[2]) : $(a).attr(e[2]) : (d = $(b, a), c ? d : d.length > 0 ? $(d).text() : void 0)
        },
        cellWidth: function() {
            var
        ...
        getRegional: function(a, b, c) {
            var
                d;
            return void
                0 !== c ? c : (a.p && a.p.regional && $.jgrid.regional && (d = $.jgrid.getAccessor($.jgrid.regional[a.p.regional] || {}, b)), void 0 === d && (d = $.jgrid.getAccessor($.jgrid, b)), d)
        },
        isMobile: function() {
            try {
                ...
                QueryObject = function(d, q) {
                    ...
                    return d.length > 0 && (_useProperties = "object" != typeof d[0] ? !1 : !0), this._hasData = function() {
                        ...
                        return void
                            0 === c && (c = 1), void
                            0 === a && (a = null), void
                            0 === b && (b = null), null === a && null === b ? 0 : null === a && null !== b ? 1 : null !== a && null === b ? -1 : "[object Date]" === d.call(a) && "[object Date]" === d.call(b) ? b > a ? -c : a > b ? c : 0 : (_usecase || "number" == typeof a || "number" == typeof b || (a = String(a), b = String(b)), b > a ? -c : a > b ? c : 0)
                        ...
                        for (var
                                 n = a.length; n > i;) g = l[i].index, k.push(a[g]), i++;
                        return k
        ...
        clearBeforeUnload: function(a) {
            ...
            if (c.grid) {
                ...
                for (d in
                    c.p) c.p.hasOwnProperty(d) && (c.p[d] = $.isArray(c.p[d]) ? [] : null);
        ...
        return this.each(function() {
            if (!this.grid) {
                        ...
                        scrollGrid: function(a) {
                            if (c.scroll) {
                                var
                                    b = e.bDiv.scrollTop;
                                void
                                    0 === e.scrollTop && (e.scrollTop = 0), b !== e.scrollTop && (e.scrollTop = b, e.timer && clearTimeout(e.timer), e.timer = setTimeout(e.populateVisible, c.scrollTimeout))
                            }
                ...
                if (void 0 !== document.documentMode && document.documentMode <= 5) return void
                    alert("Grid can not be used in this ('quirks') mode!");
                var
                    f, g, h, i = 0;
                for (g in
                    $.jgrid.regional) $.jgrid.regional.hasOwnProperty(g) && (0 === i && (f = g), i++);
                if (1 === i && f !== c.regional && (c.regional = f), $(this).empty().attr("tabindex", "0"), this.p = c, this.p.useProp = !!$.fn.prop, 0 === this.p.colNames.length)
                    for (i = 0; i < this.p.colModel.length; i++) this.p.colNames[i] = this.p.colModel[i].label || this.p.colModel[i].name;
                if (this.p.colNames.length !== this.p.colModel.length) return void
                    alert($.jgrid.getRegional(this, "errors.model"));
                var
                    j, k = $.jgrid.getMethod("getStyleUI"),
                    ...
                    p = k(l, "cornerall", !0),
                    q = k(l, "icon_base", !0),
                    r = $.jgrid.styleUI[d.p.styleUI || "jQueryUI"].colmenu,
                    s = $.jgrid.msie(),
                    t = [],
                    u = [],
                    v = [];
                ...
                var
                    w = $("<div " + k(l, "entrieBox", !1, "ui-jqgrid") + "></div>");
                $(w).attr({
                    id: "gbox_" + this.id,
                    dir: h
                }).insertBefore(j), $(j).attr("id", "gview_" + this.id).appendTo(w), $("<div " + k(d.p.styleUI + ".common", "overlay", !1, "jqgrid-overlay") + " id='lui_" + this.id + "'></div>").insertBefore(j), $("<div " + k(l, "loadingBox", !1, "loading") + " id='load_" + this.id + "'>" + $.jgrid.getRegional(d, "defaults.loadtext", this.p.loadtext) + "</div>").insertBefore(j), $(this).attr({
                    role: "presentation",
                    "aria-multiselectable": !!this.p.multiselect,
                    "aria-labelledby": "gbox_" + this.id
                });
                var
                    x, y = ["shiftKey", "altKey", "ctrlKey"],
                    z = function(a, b) {
                        return a = parseInt(a, 10), isNaN(a) ? b || 0 : a
                    },
                    A = function(a, b, c, f, g, h) {
                        var
                            i, j, k = d.p.colModel[a],
                            l = k.align,
                            m = 'style="',
                            n = k.classes,
                            o = k.name,
                    ...
                    C = function(a, b, c, e, f) {
                        ...
                        if (void 0 !== h.formatter) {
                            ...
                            g = $.isFunction(h.formatter) ? h.formatter.call(d, b, i, e, f) : $.fmatter ? $.fn.fmatter.call(d, h.formatter, b, i, e, f) : B(b)
                        } else
                            g = B(b);
                        return g
                    },
                    D = function(a, b, c, d, e, f) {
                        var
                            g, h;
                        return g = C(a, b, c, e, "add"), h = A(c, d, g, e, a, f), '<td role="gridcell" ' + h + ">" + g + "</td>"
                    },
                    E = function(a, b, c, e, f) {
                        var
                            g = '<input role="checkbox" type="checkbox" id="jqg_' + d.p.id + "_" + a + '" ' + f + ' name="jqg_' + d.p.id + "_" + a + '"' + (e ? 'checked="checked"' : "") + "/>",
                            h = A(b, c, "", null, a, !0);
                    ...
                    J = function() {
                        ...
                        if ("local" === m.datatype && p.repeatitems === !0)
                            for (j = H(s), k = G("local"), e = m.keyIndex === !1 ? $.isFunction(p.id) ? p.id.call(d, n) : p.id : m.keyIndex, a = 0; o > a; a++) {
                    ...
                    K = function() {
                        var
                            a, b, c, e = d.p.data.length;
                        for (a = d.p.keyName === !1 || d.p.loadonce === !0 ? d.p.localReader.id : d.p.keyName, d.p._index = [], b = 0; e > b; b++) c = $.jgrid.getAccessor(d.p.data[b], a), void
                            0 === c && (c = String(b + 1)), d.p._index[c] = b
                    },
                    ...
                    M = function(a, b, c, e) {
                        var
                            f = new
                            Date, g = "local" !== d.p.datatype && d.p.loadonce || "xmlstring" === d.p.datatype, h = "_id_", i = d.p.xmlReader, j = "local" === d.p.datatype ? "local" : "xml";
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            -1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b : 1 : (I.call(d, !1, !0), b = 1);
                            var
                                m, n, o, p, q, r, s, t, u, v, w = $(d),
                                x = 0,
                                y = d.p.multiselect === !0 ? 1 : 0,
                                A = 0,
                            ...
                            d.p.subGrid === !0 && (A = 1, p = $.jgrid.getMethod("addSubGridCell")), i.repeatitems || (C = G(j)), q = d.p.keyName === !1 ? $.isFunction(i.id) ? i.id.call(d, a) : i.id : d.p.keyName, r = -1 === String(q).indexOf("[") ? C.length ? function(a, b) {
                                return $(q, a).text() || b
                            } : function(a, b) {
                                return $(i.cell, a).eq(q).text() || b
                            } : function(a, b) {
                                return a.getAttribute(q.replace(/[\[\]]/g, "")) || b
                            }, d.p.userData = {}, d.p.page = z($.jgrid.getXmlData(a, i.page), d.p.page), d.p.lastpage = z($.jgrid.getXmlData(a, i.total), 1), d.p.records = z($.jgrid.getXmlData(a, i.records)), $.isFunction(i.userdata) ? d.p.userData = i.userdata.call(d, a) || {} : $.jgrid.getXmlData(a, i.userdata, !0).each(function() {
                                d.p.userData[this.getAttribute("name")] = $(this).text()
                            });
                            var
                                O = $.jgrid.getXmlData(a, i.root, !0);
                            ...
                            var
                                ...
                                V = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first");
                            if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                                e && (T *= e + 1);
                                var
                                    W, X = $.isFunction(d.p.afterInsertRow),
                                    Y = !1,
                                    Z = B ? k(l, "rownumBox", !1, "jqgrid-rownum") : "",
                                    _ = y ? k(l, "multiBox", !1, "cbox") : "";
                                for (d.p.grouping && (Y = d.p.groupingView.groupCollapse === !0, W = $.jgrid.getMethod("groupingPrepare")); Q > R;) {
                                    ...
                                    var
                                        aa = K.length;
                                    if (K.push(""), B && K.push(F(0, R, d.p.page, d.p.rowNum, Z)), y && K.push(E(u, B, R, !1, _)), A && K.push(p.call(w, y + B, R + b)), i.repeatitems) {
                                        s || (s = H(y + A + B));
                                        var
                                            ba = $.jgrid.getXmlData(t, i.cell, !0);
                                        $.each(s, function(a) {
                                            var
                                                c = ba[this];
                                            return c ? (o = c.textContent || c.text, J[d.p.colModel[a + y + A + B].name] = o, void K.push(D(u, o, a + y + A + B, R + b, t, J))) : !1
                                        })
                                    } else
                                        for (m = 0; m < C.length; m++) o = $.jgrid.getXmlData(t, C[m]), J[d.p.colModel[m + y + A + B].name] = o, K.push(D(u, o, m + y + A + B, R + b, t, J));
                                    if (K[aa] = L(u, Y, v, J, t), K.push("</tr>"), d.p.grouping && (S.push(K), d.p.groupingView._locgr || W.call(w, J, R), K = []), (g || d.p.treeGrid === !0 && !d.p._ald) && (J[h] = $.jgrid.stripPref(d.p.idPrefix, u), d.p.data.push(J), d.p._index[J[h]] = d.p.data.length - 1), d.p.gridview === !1 && (V.append(K.join("")), w.triggerHandler("jqGridAfterInsertRow", [u, J, t]), X && d.p.afterInsertRow.call(d, u, J, t), K = []), J = {}, x++, R++, x === T) break
                                }
                            }
                            if (d.p.gridview === !0 && (n = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? g || (w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T), S = null) : d.p.treeGrid === !0 && n > 0 ? $(d.rows[n]).after(K.join("")) : (V.append(K.join("")), d.grid.cols = d.rows[0].cells)), d.p.totaltime = new Date - f, K = null, d.p.subGrid === !0) try {
                                w.jqGrid("addSubGrid", y + B)
                            } catch (ca) {}
                            if (x > 0 && 0 === d.p.records && (d.p.records = Q), d.p.treeGrid === !0) try {
                            ...
                            if (d.p.reccount = x, d.p.treeANode = -1, d.p.userDataOnFooter && w.jqGrid("footerData", "set", d.p.userData, !0), g && (d.p.records = Q, d.p.lastpage = Math.ceil(Q / T)), c || d.updatepager(!1, !0), g) {
                                for (; Q > x;) {
                                    if (t = O[x], u = r(t, x + U), u = d.p.idPrefix + u, i.repeatitems) {
                                        s || (s = H(y + A + B));
                                        var
                                            ea = $.jgrid.getXmlData(t, i.cell, !0);
                                        $.each(s, function(a) {
                                            var
                                                b = ea[this];
                                            return b ? (o = b.textContent || b.text, void(J[d.p.colModel[a + y + A + B].name] = o)) : !1
                                        })
                                    } else
                                        for (m = 0; m < C.length; m++) o = $.jgrid.getXmlData(t, C[m]), J[d.p.colModel[m + y + A + B].name] = o;
                    ...
                    N = function(a, b, c, e) {
                        ...
                        if (a) {
                            ...
                            d.p.page = z($.jgrid.getAccessor(a, g.page), d.p.page), d.p.lastpage = z($.jgrid.getAccessor(a, g.total), 1), d.p.records = z($.jgrid.getAccessor(a, g.records)), d.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, K && (r = $.jgrid.getMethod("addSubGridCell")), v = d.p.keyName === !1 ? $.isFunction(g.id) ? g.id.call(d, a) : g.id : d.p.keyName, u = $.jgrid.getAccessor(a, g.root), null == u && $.isArray(a) && (u = a), u || (u = []), t = u.length, o = 0, t > 0 && d.p.page <= 0 && (d.p.page = 1);
                            var
                                T, U, V = parseInt(d.p.rowNum, 10),
                                W = d.p.scroll ? $.jgrid.randId() : 1,
                                X = !1;
                            e && (V *= e + 1), "local" !== d.p.datatype || d.p.deselectAfterSort || (X = !0);
                            var
                                Y, Z = $.isFunction(d.p.afterInsertRow),
                                _ = [],
                                aa = !1,
                                ba = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first"),
                                ca = M ? k(l, "rownumBox", !1, "jqgrid-rownum") : "",
                                da = J ? k(l, "multiBox", !1, "cbox") : "";
                            for (d.p.grouping && (aa = d.p.groupingView.groupCollapse === !0, Y = $.jgrid.getMethod("groupingPrepare")); t > o;) {
                                if (q = u[o], x = $.jgrid.getAccessor(q, v), void 0 === x && ("number" == typeof v && null != d.p.colModel[v + J + K + M] && (x = $.jgrid.getAccessor(q, d.p.colModel[v + J + K + M].name)), void 0 === x && (x = W + o, 0 === C.length && g.cell))) {
                                    var
                                        ea = $.jgrid.getAccessor(q, g.cell) || q;
                                    x = null != ea && void
                                        0 !== ea[v] ? ea[v] : x, ea = null
                                }
                                x = d.p.idPrefix + x, T = 1 === b ? 0 : b, y = S + ((T + o) % 2 === 1 ? " " + R : ""), X && (U = d.p.multiselect ? -1 !== $.inArray(x, d.p.selarrrow) : x === d.p.selrow);
                                var
                                    fa = Q.length;
                                for (Q.push(""), M && Q.push(F(0, o, d.p.page, d.p.rowNum, ca)), J && Q.push(E(x, M, o, U, da)), K && Q.push(r.call(A, J + M, o + b)), s = O, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = N)), p = 0; p < s.length; p++) m = $.jgrid.getAccessor(q, s[p]), P[d.p.colModel[p + J + K + M].name] = m, Q.push(D(x, m, p + J + K + M, o + b, q, P));
                                if (y += U ? " " + n : "", Q[fa] = L(x, aa, y, P, q), Q.push("</tr>"), d.p.grouping && (_.push(Q), d.p.groupingView._locgr || Y.call(A, P, o), Q = []), (j || d.p.treeGrid === !0 && !d.p._ald) && (P[i] = $.jgrid.stripPref(d.p.idPrefix, x), d.p.data.push(P), d.p._index[P[i]] = d.p.data.length - 1), d.p.gridview === !1 && (ba.append(Q.join("")), A.triggerHandler("jqGridAfterInsertRow", [x, P, q]), Z && d.p.afterInsertRow.call(d, x, P, q), Q = []), P = {}, B++, o++, B === V) break
                            }
                            if (d.p.gridview === !0 && (w = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), _ = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(Q.join("")) : (ba.append(Q.join("")), d.grid.cols = d.rows[0].cells)), d.p.totaltime = new Date - f, Q = null, d.p.subGrid === !0) try {
                                A.jqGrid("addSubGrid", J + M)
                            } catch (ga) {}
                            if (B > 0 && 0 === d.p.records && (d.p.records = t), d.p.treeGrid === !0) try {
                            ...
                            if (d.p.reccount = B, d.p.treeANode = -1, d.p.userDataOnFooter && A.jqGrid("footerData", "set", d.p.userData, !0), j && (d.p.records = t, d.p.lastpage = Math.ceil(t / V)), c || d.updatepager(!1, !0), j) {
                                for (; t > B && u[B];) {
                                    if (q = u[B], x = $.jgrid.getAccessor(q, v), void 0 === x && ("number" == typeof v && null != d.p.colModel[v + J + K + M] && (x = $.jgrid.getAccessor(q, d.p.colModel[v + J + K + M].name)), void 0 === x && (x = W + B, 0 === C.length && g.cell))) {
                                        var
                                            ia = $.jgrid.getAccessor(q, g.cell) || q;
                                        x = null != ia && void
                                            0 !== ia[v] ? ia[v] : x, ia = null
                                    }
                                    if (q) {
                                        for (x = d.p.idPrefix + x, s = O, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = N)), p = 0; p < s.length; p++) P[d.p.colModel[p + J + K + M].name] = $.jgrid.getAccessor(q, s[p]);
                    ...
                    O = function(a) {
                        ...
                        b(a) {
                            var
                                c, e, f, g, h, i, j = 0;
                            if (null != a.groups) {
                                for (e = a.groups.length && "OR" === a.groupOp.toString().toUpperCase(), e && s.orBegin(), c = 0; c < a.groups.length; c++) {
                                    j > 0 && e && s.or();
                                    try {
                                        b(a.groups[c])
                                    } catch (l) {
                        ...
                        if ($.isArray(d.p.data)) {
                            var
                                n, o, p, q = d.p.grouping ? d.p.groupingView : !1;
                            if ($.each(d.p.colModel, function() {
                                    if (e = this.sorttype || "text", p = this.index || this.name, "date" === e || "datetime" === e ? (this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? (c = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : $.jgrid.getRegional(d, "formatter.date.srcformat"), f = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : $.jgrid.getRegional(d, "formatter.date.newformat")) : c = f = this.datefmt || "Y-m-d", k[p] = {
                                            stype: e,
                                            srcfmt: c,
                                            newfmt: f,
                                        ...
                                        for (o = 0, n = q.groupField.length; n > o; o++) this.name === q.groupField[o] && (l[o] = k[p], m[o] = p);
                                    d.p.multiSort || j || p !== d.p.sortname || (h = p, j = !0)
                                }), d.p.multiSort && (h = t, i = u), d.p.treeGrid && d.p._sort) return void
                                $(d).jqGrid("SortTree", h, d.p.sortorder, k[h].stype || "text", k[h].srcfmt || "");
                            var
                                r = {
                                    eq: function(a) {
                                        return a.equals
                                ...
                                s = $.jgrid.from.call(d, d.p.data);
                            if (d.p.ignoreCase && (s = s.ignoreCase()), d.p.search === !0) {
                                var
                                    v = d.p.postData.filters;
                                if (v) "string" == typeof
                                    v && (v = $.jgrid.parse(v)), b(v);
                                else
                                    try {
                                        g = k[d.p.postData.searchField], "date" === g.stype && g.srcfmt && g.newfmt && g.srcfmt !== g.newfmt && (d.p.postData.searchString = $.jgrid.parseDate.call(d, g.newfmt, d.p.postData.searchString, g.srcfmt)), s = r[d.p.postData.searchOper](s)(d.p.postData.searchField, d.p.postData.searchString, k[d.p.postData.searchField])
                                    } catch (w) {}
                            } else
                                d.p.treeGrid && "nested" === d.p.treeGridModel && s.orderBy(d.p.treeReader.left_field, "asc", "integer", "", null);
                            if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (n = 0, h = null), d.p.grouping)
                                for (o = 0; n > o; o++) s.orderBy(m[o], q.groupOrder[o], l[o].stype, l[o].srcfmt);
                            d.p.multiSort ? $.each(h, function(a) {
                                s.orderBy(this, i[a], k[this].stype, k[this].srcfmt, k[this].sfunc)
                            }) : h && d.p.sortorder && j && ("DESC" === d.p.sortorder.toUpperCase() ? s.orderBy(d.p.sortname, "d", k[h].stype, k[h].srcfmt, k[h].sfunc) : s.orderBy(d.p.sortname, "a", k[h].stype, k[h].srcfmt, k[h].sfunc));
                            var
                                x = s.select(),
                                y = parseInt(d.p.rowNum, 10),
                                z = x.length,
                                A = parseInt(d.p.page, 10),
                                B = Math.ceil(z / y),
                                C = {};
                            if ((d.p.search || d.p.resetsearch) && d.p.grouping && d.p.groupingView._locgr) {
                                d.p.groupingView.groups = [];
                                var
                                    D, E, F, G = $.jgrid.getMethod("groupingPrepare");
                                if (d.p.footerrow && d.p.userDataOnFooter) {
                                    for (E in
                                        d.p.userData) d.p.userData.hasOwnProperty(E) && (d.p.userData[E] = 0);
                                    F = !0
                                }
                                for (D = 0; z > D; D++) {
                                    if (F)
                                        for (E in
                                            d.p.userData) d.p.userData.hasOwnProperty(E) && (d.p.userData[E] += parseFloat(x[D][E] || 0));
                                    G.call($(d), x[D], D, y)
                                }
                            }
                            return a ? x : (x = d.p.treeGrid && d.p.search ? $(d).jqGrid("searchTree", x) : x.slice((A - 1) * y, A * y), s = null, k = null, C[d.p.localReader.total] = B, C[d.p.localReader.page] = A, C[d.p.localReader.records] = z, C[d.p.localReader.root] = x, C[d.p.localReader.userdata] = d.p.userData, x = null, C)
                        }
                    },
                    P = function(a, b) {
                        var
                        ...
                        if (f = parseInt(d.p.page, 10) - 1, 0 > f && (f = 0), f *= parseInt(d.p.rowNum, 10), h = f + d.p.reccount, d.p.scroll) {
                            var
                                t = $("tbody:first > tr:gt(0)", d.grid.bDiv);
                            h > d.p.records && (h = d.p.records), f = h - t.length, d.p.reccount = t.length;
                            var
                                u = t.outerHeight() || d.grid.prevRowHeight;
                            if (u) {
                                var
                                    v = f * u,
                        ...
                        if (p = d.p.pager || "", p += d.p.toppager ? p ? "," + d.p.toppager : d.p.toppager : "") {
                            if (j = $.jgrid.getRegional(d, "formatter.integer"), c = z(d.p.page), e = z(d.p.lastpage), $(".selbox", p)[this.p.useProp ? "prop" : "attr"]("disabled", !1), d.p.pginput === !0 && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input " + k(l, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "'></span>")), d.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input " + k(l, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>")), $(".ui-pg-input", p).val(d.p.page), n = d.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(n).html($.fmatter ? $.fmatter.util.NumberFormat(d.p.lastpage, j) : d.p.lastpage)), d.p.viewrecords)
                                if (0 === d.p.reccount) $(".ui-paging-info", p).html($.jgrid.getRegional(d, "defaults.emptyrecords", d.p.emptyrecords));
                                else {
                                    ...
                                    var
                                        x = $.jgrid.getRegional(d, "defaults.recordtext", d.p.recordtext);
                    ...
                    R = function() {
                        d.grid.hDiv.loading = !1, $(d).jqGrid("progressBar", {
                            method: "hide",
                            loadtype: d.p.loadui
                        })
                    },
                    S = function(a) {
                        if (!d.grid.hDiv.loading) {
                            ...
                            var
                                o = d.p.scroll ? d.rows.length - 1 : 1,
                                p = $(d).triggerHandler("jqGridBeforeRequest");
                            if (p === !1 || "stop" === p) return;
                            if ($.isFunction(d.p.datatype)) return void
                                d.p.datatype.call(d, d.p.postData, "load_" + d.p.id, o, a, j);
                            ...
                            switch (b = d.p.datatype.toLowerCase()) {
                                ...
                                case "script":
                                    $.ajax($.extend({
                                        ...
                                        success: function(c, f, g) {
                                            return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1 ? void
                                                R(): ("xml" === b ? M(c, o, a > 1, j) : N(c, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [c]), i && i.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), e && d.grid.populateVisible(), (d.p.loadonce || d.p.treeGrid) && (d.p.datatype = "local"), c = null, void(1 === a && R()))
                                        },
                                        error: function(b, c, e) {
                                            $.isFunction(d.p.loadError) && d.p.loadError.call(d, b, c, e), 1 === a && R(), b = null
                                        },
                                        beforeSend: function(a, b) {
                                            var
                                                c = !0;
                                            return $.isFunction(d.p.loadBeforeSend) && (c = d.p.loadBeforeSend.call(d, a, b)), void
                                                0 === c && (c = !0), c === !1 ? !1 : void
                                                Q()
                                        }
                                ...
                                case "xmlstring":
                                    Q(), c = "string" != typeof
                                        d.p.datastr ? d.p.datastr : $.parseXML(d.p.datastr), M(c), $(d).triggerHandler("jqGridLoadComplete", [c]), h && d.p.loadComplete.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), d.p.datatype = "local", d.p.datastr = null, R();
                                    break;
                                case "jsonstring":
                                    Q(), c = "string" == typeof
                                        d.p.datastr ? $.jgrid.parse(d.p.datastr) : d.p.datastr, N(c), $(d).triggerHandler("jqGridLoadComplete", [c]), h && d.p.loadComplete.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), d.p.datatype = "local", d.p.datastr = null, R();
                                    break;
                                case "local":
                                case "clientside":
                                    Q(), d.p.datatype = "local", d.p._ald = !0;
                                    var
                                        q = O(!1);
                                    N(q, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [q]), i && i.call(d, q), $(d).triggerHandler("jqGridAfterLoadComplete", [q]), e && d.grid.populateVisible(), R(), d.p._ald = !1
                            }
                            d.p._sort = !1
                        }
                    },
                    T = function(a) {
                        ...
                        var
                            b = d.p.frozenColumns ? d.p.id + "_frozen" : "";
                        b && $("#cb_" + $.jgrid.jqID(d.p.id), d.grid.fhDiv)[d.p.useProp ? "prop" : "attr"]("checked", a)
                    },
                    U = function(a, b) {
                        var
                            c, e, f, g, i, j, n, p = "<td class='ui-pg-button " + m + "'><span class='ui-separator'></span></td>",
                            r = "",
                            ...
                            u = function(a, b) {
                                var
                                    c;
                                return $.isFunction(d.p.onPaging) && (c = d.p.onPaging.call(d, a, b)), "stop" === c ? !1 : (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], T(!1)), d.p.savedRow = [], !0)
                            };
                        if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
                            ...
                            var
                                v;
                            for (n = 0; n < d.p.rowList.length; n++) v = d.p.rowList[n].toString().split(":"), 1 === v.length && (v[1] = v[0]), t += '<option role="option" value="' + v[0] + '"' + (z(d.p.rowNum, 0) === z(v[0], 0) ? ' selected="selected"' : "") + ">" + v[1] + "</option>";
                            t += "</select></td>"
                        }
                        if ("rtl" === h && (s += t), d.p.pginput === !0 && (r = "<td id='input" + b + "' dir='" + h + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), d.p.pgbuttons === !0) {
                            var
                                ...
                                y = [$.jgrid.getRegional(d, "defaults.pgfirst", d.p.pgfirst) || "", $.jgrid.getRegional(d, "defaults.pgprev", d.p.pgprev) || "", $.jgrid.getRegional(d, "defaults.pgnext", d.p.pgnext) || "", $.jgrid.getRegional(d, "defaults.pglast", d.p.pglast) || ""];
                            "rtl" === h && (w.reverse(), y.reverse()), s += "<td id='" + w[0] + "' class='" + x + "' title='" + y[0] + "'><span " + k(l, "icon_first", !1, q) + "></span></td>", s += "<td id='" + w[1] + "' class='" + x + "'  title='" + y[1] + "'><span " + k(l, "icon_prev", !1, q) + "></span></td>", s += "" !== r ? p + r + p : "", s += "<td id='" + w[2] + "' class='" + x + "' title='" + y[2] + "'><span " + k(l, "icon_next", !1, q) + "></span></td>", s += "<td id='" + w[3] + "' class='" + x + "' title='" + y[3] + "'><span " + k(l, "icon_end", !1, q) + "></span></td>"
                        } else "" !== r && (s += r);
                        "ltr" === h && (s += t), s += "</tr></tbody></table>", d.p.viewrecords === !0 && $("td#" + a + "_" + d.p.recordpos, "#" + c).append("<div dir='" + h + "' style='text-align:" + d.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + d.p.pagerpos, "#" + c).append(s), j = $("#gbox_" + $.jgrid.jqID(d.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(d.p.id)).append("<div id='testpg' " + k(l, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), i = $(s).clone().appendTo("#testpg").width(), $("#testpg").remove(), i > 0 && ("" !== r && (i += 50), $("td#" + a + "_" + d.p.pagerpos, "#" + c).width(i)), d.p._nvtd = [], d.p._nvtd[0] = i ? Math.floor((d.p.width - i) / 2) : Math.floor(d.p.width / 3), d.p._nvtd[1] = 0, s = null, $(".ui-pg-selbox", "#" + c).on("change", function() {
                            return u("records", this) ? (d.p.page = Math.round(d.p.rowNum * (d.p.page - 1) / this.value - .5) + 1, d.p.rowNum = this.value, d.p.pager && $(".ui-pg-selbox", d.p.pager).val(this.value), d.p.toppager && $(".ui-pg-selbox", d.p.toppager).val(this.value), S(), !1) : !1
                            ...
                            var
                                ...
                                h = !0,
                                i = !0;
                            return 0 === c || 1 === c ? (f = !1, g = !1, h = !1, i = !1) : c > 1 && a >= 1 ? 1 === a ? (f = !1, g = !1) : a === c && (h = !1, i = !1) : c > 1 && 0 === a && (h = !1, i = !1, a = c - 1), u(this.id.split("_")[0], this) ? (this.id === "first" + b && f && (d.p.page = 1, e = !0), this.id === "prev" + b && g && (d.p.page = a - 1, e = !0), this.id === "next" + b && h && (d.p.page = a + 1, e = !0), this.id === "last" + b && i && (d.p.page = c, e = !0), e && S(), !1) : !1
                        })), d.p.pginput === !0 && $("#" + c).on("keypress", "input.ui-pg-input", function(a) {
                            var
                                b = a.charCode || a.keyCode || 0;
                            return 13 === b ? u("user", this) ? ($(this).val(z($(this).val(), 1)), d.p.page = $(this).val() > 0 ? $(this).val() : d.p.page, S(), !1) : !1 : this
                        })
                    },
                    V = function(a, b, c) {
                        var
                            e, f = d.p.colModel,
                            g = d.p.frozenColumns ? b : d.grid.headers[a].el,
                            h = "";
                        $("span.ui-grid-ico-sort", g).addClass(m), $(g).attr("aria-selected", "false"), e = f[a].index || f[a].name, "undefined" == typeof
                            c ? f[a].lso ? "asc" === f[a].lso ? (f[a].lso += "-desc", h = "desc") : "desc" === f[a].lso ? (f[a].lso += "-asc", h = "asc") : ("asc-desc" === f[a].lso || "desc-asc" === f[a].lso) && (f[a].lso = "") : f[a].lso = h = f[a].firstsortorder || "asc" : f[a].lso = h = c, h ? ($("span.s-ico", g).show(), $("span.ui-icon-" + h, g).removeClass(m), $(g).attr("aria-selected", "true")) : d.p.viewsortcols[0] || $("span.s-ico", g).hide();
                        var
                            i = t.indexOf(e); - 1 === i ? (t.push(e), u.push(h)) : h ? u[i] = h : (u.splice(i, 1), t.splice(i, 1)), d.p.sortorder = "", d.p.sortname = "";
                        for (var
                                 j = 0, k = t.length; k > j; j++) j > 0 && (d.p.sortname += ", "), d.p.sortname += t[j], j !== k - 1 && (d.p.sortname += " " + u[j]);
                        d.p.sortorder = u[k - 1]
                    },
                    W = function(a, b, c, e, f) {
                        if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                            if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort) V(b, f, e);
                            else {
                                if (e) {
                                ...
                                var
                                    g, h = d.grid.headers[d.p.lastsort] ? d.grid.headers[d.p.lastsort].el : null,
                            ...
                            if ("local" === d.p.datatype ? d.p.deselectAfterSort && $(d).jqGrid("resetSelection") : (d.p.selrow = null, d.p.multiselect && T(!1), d.p.selarrrow = [], d.p.savedRow = []), d.p.scroll) {
                                var
                                    k = d.grid.bDiv.scrollLeft;
                                I.call(d, !0, !1), d.grid.hDiv.scrollLeft = k
                            }
                            d.p.subGrid && "local" === d.p.datatype && $("td.sgexpanded", "#" + $.jgrid.jqID(d.p.id)).each(function() {
                                $(this).trigger("click")
                            }), d.p._sort = !0, S(), d.p.lastsort = b, d.p.sortname !== a && b && (d.p.lastsort = b)
                        }
                    },
                    X = function() {
                        var
                            a, b, c, f, g = 0,
                            h = $.jgrid.cell_width ? 0 : z(d.p.cellLayout, 0),
                            i = 0,
                            j = z(d.p.scrollOffset, 0),
                            k = !1,
                            l = 0;
                        $.each(d.p.colModel, function() {
                            if (void 0 === this.hidden && (this.hidden = !1), d.p.grouping && d.p.autowidth) {
                                var
                                    a = $.inArray(this.name, d.p.groupingView.groupField);
                                a >= 0 && d.p.groupingView.groupColumnShow.length > a && (this.hidden = !d.p.groupingView.groupColumnShow[a])
                            }
                            this.widthOrg = b = z(this.width, 0), this.hidden === !1 && (g += b + h, this.fixed ? l += b + h : i++)
                        }), isNaN(d.p.width) && (d.p.width = g + (d.p.shrinkToFit !== !1 || isNaN(d.p.height) ? 0 : j)), e.width = parseInt(d.p.width, 10), d.p.tblwidth = g, d.p.shrinkToFit === !1 && d.p.forceFit === !0 && (d.p.forceFit = !1), d.p.shrinkToFit === !0 && i > 0 && (c = e.width - h * i - l, isNaN(d.p.height) || (c -= j, k = !0), g = 0, $.each(d.p.colModel, function(e) {
                    ...
                    Y = function(a) {
                        var
                            b, c = a,
                            e = a;
                        for (b = a + 1; b < d.p.colModel.length; b++)
                            if (d.p.colModel[b].hidden !== !0) {
                                e = b;
                                break
                            }
                        return e - c
                    ...
                    aa = function(a, b, c) {
                        var
                            ...
                            h = g.length,
                            i = [],
                            j = $.jgrid.getRegional(d, "colmenu"),
                            k = '<ul id="col_menu" class="ui-search-menu  ui-col-menu modal-content" role="menu" tabindex="0" style="left:' + b + "px;top:" + a + 'px;">';
                        for (e = 0; h > e; e++) {
                            var
                                l = g[e].hidden ? "" : "checked",
                                m = g[e].name,
                                n = d.p.colNames[e];
                            f = "cb" === m || "subgrid" === m || "rn" === m || g[e].hidedlg ? "style='display:none'" : "", k += "<li " + f + ' class="ui-menu-item" role="presentation" draggable="true"><a class="g-menu-item" tabindex="0" role="menuitem" ><table class="ui-common-table" ><tr><td class="menu_icon" title="' + j.reorder + '"><span class="' + q + " " + r.icon_move + ' notclick"></span></td><td class="menu_icon"><input class="' + r.input_checkbox + '" type="checkbox" name="' + m + '" ' + l + '></td><td class="menu_text">' + n + "</td></tr></table></a></li>", i.push(e)
                        }
                        k += "</ul>", $(c).append(k), $("#col_menu").addClass("ui-menu " + r.menu_widget), $.fn.html5sortable() && $("#col_menu").html5sortable({
                            handle: "span",
                            forcePlaceholderSize: !0
                        }).on("sortupdate", function(a, b) {
                            for (i.splice(b.startindex, 1), i.splice(b.endindex, 0, b.startindex), $(d).jqGrid("destroyFrozenColumns"), $(d).jqGrid("remapColumns", i, !0), $(d).jqGrid("setFrozenColumns"), e = 0; h > e; e++) i[e] = e
                        }), $("#col_menu > li > a").on("click", function(a) {
                            var
                                b;
                            $(a.target).hasClass("notclick") || ($(a.target).is(":input") ? b = $(a.target).is(":checked") : (b = !$("input", this).is(":checked"), $("input", this).prop("checked", b)), b ? ($(d).jqGrid("showCol", $("input", this).attr("name")), $(this).parent().attr("draggable", "true")) : ($(d).jqGrid("hideCol", $("input", this).attr("name")), $(this).parent().attr("draggable", "false")))
                        }).hover(function() {
                            $(this).addClass(o)
                        }, function() {
                            $(this).removeClass(o)
                    ...
                    ba = function(a, b, c, e) {
                        var
                            ...
                            v = $.jgrid.getRegional(d, "search"),
                            w = $.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common;
                        if (k) {
                            f = d.p.colFilters && d.p.colFilters[k.name] ? d.p.colFilters[k.name] : !1, f && !$.isEmptyObject(f) && (l = f.oper1, m = f.value1, n = f.rule, p = f.oper2, q = f.value2), k.searchoptions || (k.searchoptions = {}), g = k.searchoptions.sopt ? k.searchoptions.sopt : "text" === k.sorttype ? u : t, h = k.searchoptions.operands ? k.searchoptions.operands : v.groupOps, j = $("<form></form>");
                            var
                                x = "<div>" + $.jgrid.getRegional(d, "colmenu.searchTitle") + "</div>";
                            x += '<div><select id="oper1" class="' + r.filter_select + '">', $.each(v.odata, function(a, b) {
                                i = b.oper === l ? 'selected="selected"' : "", -1 !== $.inArray(b.oper, g) && (s += '<option value="' + b.oper + '" ' + i + ">" + b.text + "</option>")
                            }), x += s, x += "</select></div>", j.append(x);
                            var
                                y = "";
                            k.searchoptions.defaultValue && (y = $.isFunction(k.searchoptions.defaultValue) ? k.searchoptions.defaultValue.call(d) : k.searchoptions.defaultValue), m && (y = m);
                            var
                                z = $.extend(k.searchoptions, {
                                    name: k.index || k.name,
                                    id: "sval1_" + d.p.idPrefix + k.name,
                                    oper: "search"
                                }),
                                A = $.jgrid.createEl.call(d, k.stype, z, y, !1, $.extend({}, $.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {}));
                            $(A).addClass(r.filter_input), x = $("<div></div>").append(A), j.append(x), x = '<div><select id="operand" class="' + r.filter_select + '">', $.each(h, function(a, b) {
                                i = b.op === n ? 'selected="selected"' : "", x += "<option value='" + b.op + "' " + i + ">" + b.text + "</option>"
                            }), x += "</select></div>", j.append(x), s = "", $.each(v.odata, function(a, b) {
                                i = b.oper === p ? 'selected="selected"' : "", -1 !== $.inArray(b.oper, g) && (s += '<option value="' + b.oper + '" ' + i + ">" + b.text + "</option>")
                            }), x = '<div><select id="oper2" class="' + r.filter_select + '">' + s + "</select></div>", j.append(x), y = q ? q : "", z = $.extend(k.searchoptions, {
                                name: k.index || k.name,
                                id: "sval2_" + d.p.idPrefix + k.name,
                                oper: "search"
                            }), A = $.jgrid.createEl.call(d, k.stype, z, y, !1, $.extend({}, $.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), $(A).addClass(r.filter_input), x = $("<div></div>").append(A), j.append(x), x = "<div>", x += "<div class='search_buttons'><a tabindex='0' id='bs_reset' class='fm-button " + w.button + " ui-reset'>" + v.Reset + "</a></div>", x += "<div class='search_buttons'><a tabindex='0' id='bs_search' class='fm-button " + w.button + " ui-search'>" + v.Find + "</a></div>", x += "</div>", j.append(x), j = $('<li class="ui-menu-item" role="presentation"></li>').append(j), j = $('<ul id="search_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="left:' + c + "px;top:" + b + 'px;"></ul>').append(j), $(e).append(j), $("#search_menu").addClass("ui-menu " + r.menu_widget), $("#bs_reset, #bs_search", "#search_menu").hover(function() {
                                $(this).addClass(o)
                            }, function() {
                                $(this).removeClass(o)
                            }), $(j).find("#bs_reset").click(function(a) {
                                return d.p.colFilters[k.name] = {}, d.p.postData.filters = ca(), d.p.search = !0, $(d).trigger("reloadGrid"), $("#column_menu").remove(), !1
                            }), $(j).find("#bs_search").click(function(a) {
                                return d.p.colFilters[k.name] = {
                                    oper1: $("#oper1", "#search_menu").val(),
                                    value1: $("#sval1_" + d.p.idPrefix + k.name, "#search_menu").val(),
                                    rule: $("#operand", "#search_menu").val(),
                                    oper2: $("#oper2", "#search_menu").val(),
                                    value2: $("#sval2_" + d.p.idPrefix + k.name, "#search_menu").val()
                                }, d.p.postData.filters = ca(), d.p.search = !0, $(d).trigger("reloadGrid"), $("#column_menu").remove(), !1
                            })
                        }
                    },
                    ca = function() {
                        ...
                        for (var
                            e in
                            d.p.colFilters)
                            if (d.p.colFilters.hasOwnProperty(e)) {
                                var
                                    f = d.p.colFilters[e];
                                $.isEmptyObject(f) || (c > 0 && (b += ","), b += '{"groupOp": "' + f.rule + '", "rules" : [', b += '{"field":"' + e + '",', b += '"op":"' + f.oper1 + '",', f.value1 += "", b += '"data":"' + f.value1.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', f.value2 && (b += ',{"field":"' + e + '",', b += '"op":"' + f.oper2 + '",', f.value2 += "", b += '"data":"' + f.value2.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}'), b += "]}", c++)
                            }
                        return b += "]}"
                    },
                    da = function(a, b) {
                        var
                            c = d.p.colModel[a],
                            e = d.p.groupingView; - 1 !== b ? e.groupField.splice(b, 1) : e.groupField.push(c.name), $(d).jqGrid("groupingGroupBy", e.groupField), d.p.frozenColumns && ($(d).jqGrid("destroyFrozenColumns"), $(d).jqGrid("setFrozenColumns"))
                    },
                    ea = function(a, b) {
                        var
                            c, e = [],
                            f = d.p.colModel.length,
                            g = -1,
                            h = d.p.colModel;
                        for (c = 0; f > c; c++) h[c].frozen && (g = c), e.push(c);
                        e.splice(a, 1), e.splice(g + (b ? 1 : 0), 0, a), h[a].frozen = b, $(d).jqGrid("destroyFrozenColumns"), $(d).jqGrid("remapColumns", e, !0), $(d).jqGrid("setFrozenColumns")
                    },
                    fa = function(a, b, c) {
                        b = parseInt(b, 10), c = parseInt(c, 10) + 25;
                        var
                            e, f, g = $(".ui-jqgrid-view").css("font-size") || "11px",
                ...
                }, d.p.localReader), d.p.scroll && (d.p.pgbuttons = !1, d.p.pginput = !1, d.p.rowList = []), d.p.data.length && (J(), K());
                var
                    ia, ja, ka, la, ma, na, oa, pa, qa, ra = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                    sa = "",
                    ta = "",
                    ua = "";
                if (d.p.shrinkToFit === !0 && d.p.forceFit === !0)
                    for (i = d.p.colModel.length - 1; i >= 0; i--)
                        if (!d.p.colModel[i].hidden) {
                            d.p.colModel[i].resizable = !1;
                            break
                        }
                if ("horizontal" === d.p.viewsortcols[1] ? (ta = " ui-i-asc", ua = " ui-i-desc") : "single" === d.p.viewsortcols[1] && (ta = " ui-single-sort-asc", ua = " ui-single-sort-desc", sa = " style='display:none'", d.p.viewsortcols[0] = !1), ia = s ? "class='ui-th-div-ie'" : "", pa = "<span class='s-ico' style='display:none'>", pa += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + ta + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_asc", !0) + "'" + sa + "></span>", pa += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + ua + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_desc", !0) + "'" + sa + "></span></span>", d.p.multiSort && d.p.sortname)
                    for (t = d.p.sortname.split(","), i = 0; i < t.length; i++) v = $.trim(t[i]).split(" "), t[i] = $.trim(v[0]), u[i] = v[1] ? $.trim(v[1]) : d.p.sortorder || "asc";
                for (i = 0; i < this.p.colNames.length; i++) {
                    var
                        va = d.p.headertitles ? ' title="' + $.jgrid.stripHtml(d.p.colNames[i]) + '"' : "";
                    qa = d.p.colModel[i], qa.hasOwnProperty("colmenu") || (qa.colmenu = "rn" === qa.name || "cb" === qa.name || "subgrid" === qa.name ? !1 : !0), ra += "<th id='" + d.p.id + "_" + qa.name + "' role='columnheader' " + k(l, "headerBox", !1, "ui-th-column ui-th-" + h) + " " + va + ">", ja = qa.index || qa.name, ra += "<div class='ui-th-div' id='jqgh_" + d.p.id + "_" + qa.name + "' " + ia + ">" + d.p.colNames[i], qa.width ? qa.width = parseInt(qa.width, 10) : qa.width = 150, "boolean" != typeof
                        qa.title && (qa.title = !0), qa.lso = "", ja === d.p.sortname && (d.p.lastsort = i), d.p.multiSort && (v = $.inArray(ja, t), -1 !== v && (qa.lso = u[v])), ra += pa, d.p.colMenu && qa.colmenu && (ra += "<a class='colmenu' href='#/'><span class='colmenuspan " + q + " " + r.icon_menu + "'></span></a>"), ra += "</div></th>"
                }
                if (ra += "</tr></thead>", pa = null, qa = null, $(this).append(ra), $("thead tr:first th", this).hover(function() {
                        $(this).addClass(o)
                    }, function() {
                        $(this).removeClass(o)
                    }), this.p.multiselect) {
                    var
                        wa, xa = [];
                    $("#cb_" + $.jgrid.jqID(d.p.id), this).on("click", function() {
                        d.p.selarrrow = [];
                        var
                            a = d.p.frozenColumns === !0 ? d.p.id + "_frozen" : "";
                        ...
                        }), wa = !0, xa = []) : ($(d.rows).each(function(b) {
                        ...
                        }), d.p.selrow = null, wa = !1), $(d).triggerHandler("jqGridSelectAll", [wa ? d.p.selarrrow : xa, wa]), $.isFunction(d.p.onSelectAll) && d.p.onSelectAll.call(d, wa ? d.p.selarrrow : xa, wa)
                    })
                }
                if (d.p.autowidth === !0) {
                    var
                        ya = $(w).innerWidth();
                    d.p.width = ya > 0 ? ya : "nw"
                }
                X(), $(w).css("width", e.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + d.p.id + "'>&#160;</div>"), d.p.scrollPopUp && $(w).append("<div " + k(l, "scrollBox", !1, "loading ui-scroll-popup") + " id='scroll_g" + d.p.id + "'></div>"), $(j).css("width", e.width + "px"), ra = $("thead:first", d).get(0);
                var
                    za = "";
                d.p.footerrow && (za += "<table role='presentation' style='width:" + d.p.tblwidth + "px' " + k(l, "footerTable", !1, "ui-jqgrid-ftable ui-common-table") + "><tbody><tr role='row' " + k(l, "footerBox", !1, "footrow footrow-" + h) + ">");
                var
                    Aa = $("tr:first", ra),
                    Ba = "<tr class='jqgfirstrow' role='row'>";
                if (d.p.disableClick = !1, $("th", Aa).each(function(a) {
                        qa = d.p.colModel[a], ka = qa.width, void
                            0 === qa.resizable && (qa.resizable = !0), qa.resizable ? (la = document.createElement("span"), $(la).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : la = "", $(this).css("width", ka + "px").prepend(la), la = null;
                        var
                            b = "";
                        qa.hidden && ($(this).css("display", "none"), b = "display:none;"), Ba += "<td role='gridcell' style='height:0px;width:" + ka + "px;" + b + "'></td>", e.headers[a] = {
                            width: ka,
                            el: this
                        }, sa = qa.sortable, "boolean" != typeof
                            sa && (qa.sortable = !0, sa = !0);
                        var
                            c = qa.name;
                        "cb" !== c && "subgrid" !== c && "rn" !== c && d.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"), sa && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), d.p.colModel[a].lso && $("div span.ui-icon-" + qa.lso, this).removeClass(m).css("display", "")) : d.p.colModel[a].lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + qa.lso, this).removeClass(m).css("display", "")) : d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === d.p.lastsort && $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", "")) : a === d.p.lastsort && "" !== d.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", ""))), d.p.footerrow && (za += "<td role='gridcell' " + A(a, 0, "", null, "", !1) + ">&#160;</td>")
                    }).mousedown(function(a) {
                        if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
                            var
                                b = _(this);
                            return d.p.forceFit === !0 && (d.p.nv = Y(b)), e.dragStart(b, a, Z(b)), !1
                        }
                    }).click(function(a) {
                        if (d.p.disableClick) return d.p.disableClick = !1, !1;
                        var
                            b, c, e = "th>div.ui-jqgrid-sortable";
                        d.p.viewsortcols[2] || (e = "th>div>span>span.ui-grid-ico-sort");
                        var
                            f = $(a.target).closest(e);
                        if (1 === f.length) {
                            var
                                g;
                            if (d.p.frozenColumns) {
                                var
                                    h = $(this)[0].id.substring(d.p.id.length + 1);
                                $(d.p.colModel).each(function(a) {
                                    return this.name === h ? (g = a, !1) : void
                                        0
                                })
                            } else
                                g = _(this);
                            if ($(a.target).hasClass("colmenuspan")) {
                                ...
                                var
                                    ...
                                    k = j.left,
                                    l = j.top;
                                return "ltr" === d.p.direction && (k += $(this).outerWidth()), fa(i, k, l, f), void
                                    a.stopPropagation()
                            }
                            return d.p.viewsortcols[2] || (b = !0, c = f.attr("sort")), null != g && W($("div", this)[0].id, g, b, c, this), !1
                        }
                    }), qa = null, d.p.sortable && $.fn.sortable) try {
                    $(d).jqGrid("sortableColumns", Aa)
                } catch (Ca) {}
                d.p.footerrow && (za += "</tr></tbody></table>"), Ba += "</tr>", oa = document.createElement("tbody"), this.appendChild(oa), $(this).addClass(k(l, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Ba), Ba = null;
                var
                    Da = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ra),
                    Ea = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1,
                    Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"),
                    Ga = "Bootstrap" !== d.p.styleUI || isNaN(d.p.height) ? 0 : 2;
                ra = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width - Ga + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(Fa), $(Fa).append(Da), Da = null, Ea && $(e.hDiv).hide(), d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({
                    width: e.width + "px"
                }).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(w), Ea && $(d.p.pager).hide(), U(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).on({
                    mouseover: function(a) {
                        na = $(a.target).closest("tr.jqgrow"), "ui-subgrid" !== $(na).attr("class") && $(na).addClass(o)
                    },
                    mouseout: function(a) {
                        na = $(a.target).closest("tr.jqgrow"), $(na).removeClass(o)
                    }
                });
                var
                    Ha, Ia, Ja;
                $(d).before(e.hDiv).on({
                    click: function(a) {
                        if (ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 === $(na).length || na[0].className.indexOf(m) > -1 || ($(ma, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id) return this;
                        var
                            b = $(ma).filter(":enabled").hasClass("cbox"),
                            c = $(d).triggerHandler("jqGridBeforeSelectRow", [na[0].id, a]);
                        if (c = c === !1 || "stop" === c ? !1 : !0, $.isFunction(d.p.beforeSelectRow)) {
                            var
                                e = d.p.beforeSelectRow.call(d, na[0].id, a);
                            (e === !1 || "stop" === e) && (c = !1)
                        }
                        if ("A" !== ma.tagName && ("INPUT" !== ma.tagName && "TEXTAREA" !== ma.tagName && "OPTION" !== ma.tagName && "SELECT" !== ma.tagName || b))
                            if (Ha = na[0].id, ma = $(ma).closest("tr.jqgrow>td"), ma.length > 0 && (Ia = $.jgrid.getCellIndex(ma), Ja = $(ma).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [Ha, Ia, Ja, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, Ha, Ia, Ja, a)), d.p.cellEdit !== !0) {
                                if (c)
                                    if (d.p.multikey) a[d.p.multikey] ? $(d).jqGrid("setSelection", Ha, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ha).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ha)[d.p.useProp ? "prop" : "attr"]("checked", !b));
                                    else
                                    if (d.p.multiselect && d.p.multiboxonly)
                                        if (b) $(d).jqGrid("setSelection", Ha, !0, a);
                                        else {
                                            var
                                                f = d.p.frozenColumns ? d.p.id + "_frozen" : "";
                                            $(d.p.selarrrow).each(function(a, b) {
                                                var
                                                    c = $(d).jqGrid("getGridRowById", b);
                                                c && $(c).removeClass(n), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b))[d.p.useProp ? "prop" : "attr"]("checked", !1), f && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f)).removeClass(n), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f))[d.p.useProp ? "prop" : "attr"]("checked", !1))
                                            }), d.p.selarrrow = [], $(d).jqGrid("setSelection", Ha, !0, a)
                                        }
                                    else
                                        $(d).jqGrid("setSelection", Ha, !0, a)
                            } else
                            if (d.p.multiselect && b && c) $(d).jqGrid("setSelection", Ha, !0, a);
                            else
                            if (ma.length > 0) try {
                                $(d).jqGrid("editCell", na[0].rowIndex, Ia, !0)
                            } catch (g) {}
                    },
                    reloadGrid: function(a, b) {
                        if (d.p.treeGrid === !0 && (d.p.datatype = d.p.treedatatype), b = b || {}, b.current && d.grid.selectionPreserver(d), "local" === d.p.datatype ? ($(d).jqGrid("resetSelection"), d.p.data.length && (J(), K())) : d.p.treeGrid || (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], T(!1)), d.p.savedRow = []), d.p.scroll && I.call(d, !0, !1), b.page) {
                            var
                                c = b.page;
                            c > d.p.lastpage && (c = d.p.lastpage), 1 > c && (c = 1), d.p.page = c, d.grid.prevRowHeight ? d.grid.bDiv.scrollTop = (c - 1) * d.grid.prevRowHeight * d.p.rowNum : d.grid.bDiv.scrollTop = 0
                        }
                        return d.grid.prevRowHeight && d.p.scroll && void
                            0 === b.page ? (delete d.p.lastpage, d.grid.populateVisible()) : d.grid.populate(), d.p.inlineNav === !0 && $(d).jqGrid("showAddEditButtons"), !1
                    },
                    dblclick: function(a) {
                        if (ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 !== $(na).length) {
                            Ha = na[0].rowIndex, Ia = $.jgrid.getCellIndex(ma);
                            var
                                b = $(d).triggerHandler("jqGridDblClickRow", [$(na).attr("id"), Ha, Ia, a]);
                            return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(na).attr("id"), Ha, Ia, a), null != b) ? b : void
                                0
                        }
                    },
                    contextmenu: function(a) {
                        if (ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 !== $(na).length) {
                            d.p.multiselect || $(d).jqGrid("setSelection", na[0].id, !0, a), Ha = na[0].rowIndex, Ia = $.jgrid.getCellIndex(ma);
                            var
                                b = $(d).triggerHandler("jqGridRightClickRow", [$(na).attr("id"), Ha, Ia, a]);
                            return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(na).attr("id"), Ha, Ia, a), null != b) ? b : void
                                0
                        }
                    }
                }), e.bDiv = document.createElement("div"), s && "auto" === String(d.p.height).toLowerCase() && (d.p.height = "100%"), $(e.bDiv).append($('<div style="position:relative;"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                    height: d.p.height + (isNaN(d.p.height) ? "" : "px"),
                    width: e.width - Ga + "px"
                }).scroll(e.scrollGrid), $("table:first", e.bDiv).css({
                    width: d.p.tblwidth + "px"
                }), $.support.tbody || 2 === $("tbody", this).length && $("tbody:gt(0)", this).remove(), d.p.multikey && ($.jgrid.msie() ? $(e.bDiv).on("selectstart", function() {
                    return !1
                }) : $(e.bDiv).on("mousedown", function() {
                    return !1
                })), Ea && $(e.bDiv).hide();
                var
                    Ka = q + " " + k(l, "icon_caption_open", !0),
                    La = q + " " + k(l, "icon_caption_close", !0);
                e.cDiv = document.createElement("div");
                var
                    Ma = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() {
                        Ma.addClass(o)
                    }, function() {
                        Ma.removeClass(o)
                    }).append("<span class='ui-jqgrid-headlink " + Ka + "'></span>").css("rtl" === h ? "left" : "right", "0px") : "";
                if ($(e.cDiv).append(Ma).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0]) {
                    var
                        Na = k(l, "customtoolbarBox", !0, "ui-userdata");
                    e.uDiv = document.createElement("div"), "top" === d.p.toolbar[1] ? $(e.uDiv).insertBefore(e.hDiv) : "bottom" === d.p.toolbar[1] && $(e.uDiv).insertAfter(e.hDiv), "both" === d.p.toolbar[1] ? (e.ubDiv = document.createElement("div"), $(e.uDiv).addClass(Na + " ui-userdata-top").attr("id", "t_" + this.id).insertBefore(e.hDiv).width(e.width - Ga), $(e.ubDiv).addClass(Na + " ui-userdata-bottom").attr("id", "tb_" + this.id).insertAfter(e.hDiv).width(e.width - Ga), Ea && $(e.ubDiv).hide()) : $(e.uDiv).width(e.width - Ga).addClass(Na + " ui-userdata-top").attr("id", "t_" + this.id), Ea && $(e.uDiv).hide()
                }
                if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width - Ga).insertBefore(e.hDiv), U(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(Fa).width(e.width - Ga).insertAfter(e.hDiv), $(Fa).append(za), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")), Ea && $(e.sDiv).hide()), Fa = null, d.p.caption) {
                    var
                        Oa = d.p.datatype;
                    d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
                        var
                            b, c = $.isFunction(d.p.onHeaderClick),
                        ...
                        return d.p.toolbar[0] === !0 && ("both" === d.p.toolbar[1] && (f += ", #" + $(e.ubDiv).attr("id")), f += ", #" + $(e.uDiv).attr("id")), b = $(f, "#gview_" + $.jgrid.jqID(d.p.id)).length, "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function() {
                            b--, 0 === b && ($("span", g).removeClass(Ka).addClass(La), d.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).hide(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (Ea || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function() {
                                b--, 0 === b && ($("span", g).removeClass(La).addClass(Ka), Ea && (d.p.datatype = Oa, S(), Ea = !1), d.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).show(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (Ea || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                            }), !1
                    }), Ea && (d.p.datatype = "local", $(".ui-jqgrid-titlebar-close", e.cDiv).trigger("click")))
                } else
                    $(e.cDiv).hide(), d.p.toppager || $(e.hDiv).addClass(k(d.p.styleUI + ".common", "cornertop", !0));
                if ($(e.hDiv).after(e.bDiv).mousemove(function(a) {
                        return e.resizing ? (e.dragMove(a), !1) : void
                            0
                    }), $(".ui-jqgrid-labels", e.hDiv).on("selectstart", function() {
                        return !1
                    }), $(document).on("mouseup.jqGrid" + d.p.id, function() {
                        return e.resizing ? (e.dragEnd(!0), !1) : !0
                    }), "rtl" === d.p.direction && $(d).on("jqGridAfterGridComplete.setRTLPadding", function() {
                        var
                            a = e.bDiv.offsetWidth - e.bDiv.clientWidth;
                        d.p.scrollOffset = a, $("div:first", e.hDiv).css({
                            paddingLeft: a + "px"
                        }), e.hDiv.scrollLeft = e.bDiv.scrollLeft
                    }), d.formatCol = A, d.sortData = W, d.updatepager = P, d.refreshIndex = K, d.setHeadCheckBox = T, d.constructTr = L, d.formatter = function(a, b, c, d, e) {
                        return C(a, b, c, d, e)
                    }, $.extend(e, {
                        populate: S,
                        emptyRows: I,
                        ...
                        N(a)
                    }, d.addLocalData = function(a) {
                        return O(a)
                    }, this.grid.cols = this.rows[0].cells, $(d).triggerHandler("jqGridInitGrid"), $.isFunction(d.p.onInitGrid) && d.p.onInitGrid.call(d), S(), d.p.hiddengrid = !1, d.p.responsive) {
                    var
        ...
        getRowData: function(a, b) {
            ...
            return this.each(function() {
                ...
                for (b && b === !0 && j.p.data.length > 0 || (b = !1); d > g;) f && (i = j.rows[g + 1]), $(i).hasClass("jqgrow") && (b ? e = j.p.data[j.p._index[i.id]] : $('td[role="gridcell"]', i).each(function(a) {
            ...
            return this.each(function() {
                ...
                if (b) try {
                    if ($(this.p.colModel).each(function(c) {
                            ...
                            void
                                0 !== f && (k[d] = this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? $.unformat.date.call(i, f, this) : f, g = i.formatter(a, k[d], c, b, "edit"), e = this.title ? {
        ...
        addRowData: function(a, b, c, d) {
            ...
            var
                e, f, g, h, i, j, k, l, m, n, o, p, q, r, s = !1,
                t = "",
                u = "",
                v = "";
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if ("boolean" != typeof b && (b = g.p.shrinkToFit), !isNaN(a)) {
                        if (a = parseInt(a, 10), g.grid.width = g.p.width = a, $("#gbox_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $("#gview_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $(g.grid.bDiv).css("width", a - n + "px"), $(g.grid.hDiv).css("width", a - n + "px"), g.p.pager && $(g.p.pager).css("width", a + "px"), g.p.toppager && $(g.p.toppager).css("width", a - n + "px"), g.p.toolbar[0] === !0 && ($(g.grid.uDiv).css("width", a - n + "px"), "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a - n + "px")), g.p.footerrow && $(g.grid.sDiv).css("width", a - n + "px"), b === !1 && g.p.forceFit === !0 && (g.p.forceFit = !1), b === !0) {
        ...
        setLabel: function(a, b, c, d) {
            return this.each(function() {
                ...
                if (e.grid && null != a && (isNaN(a) ? $(e.p.colModel).each(function(b) {
                    ...
                    c && ("string" == typeof c ? $(g).addClass(c) : $(g).css(c)), "object" == typeof
                        d && $(g).attr(d)
                }
            })
        },
        ...
        getCell: function(a, b) {
            ...
            return this.each(function() {
                ...
                if (f.grid && (d = b, isNaN(b) ? $(f.p.colModel).each(function(a) {
                        return this.name === b ? (d = this.name, g = a, !1) : void
                            0
                    }) : g = parseInt(b, 10), g >= 0)) {
                ...
                $("body").is("[role]") || $("body").attr("role", "application"), a.p.scrollrows = b.scrollingRows, $(a).keydown(function(c) {
                    ...
                    if (g)
                        if (f = a.p._index[$.jgrid.stripPref(a.p.idPrefix, g.id)], 37 === c.keyCode || 38 === c.keyCode || 39 === c.keyCode || 40 === c.keyCode) {
                            ...
                            13 === c.keyCode ? ($(a).triggerHandler("jqGridKeyEnter", [a.p.selrow]), $.isFunction(b.onEnter) && b.onEnter.call(a, a.p.selrow)) : 32 === c.keyCode && ($(a).triggerHandler("jqGridKeySpace", [a.p.selrow]), $.isFunction(b.onSpace) && b.onSpace.call(a, a.p.selrow))
                })
            })
        },
        unbindKeys: function() {
        ...
        getLocalRow: function(a) {
            ...
            return this.each(function() {
                void
                    0 !== a && (b = this.p._index[$.jgrid.stripPref(this.p.idPrefix, a)], b >= 0 && (c = this.p.data[b]))
            }), c
        },
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (a.p.subGrid !== !0 && a.p.treeGrid !== !0 && a.p.cellEdit !== !0 && !a.p.sortable && !a.p.scroll) {
                        ...
                        if (e >= 0 && f) {
                            var
                                i = a.p.caption ? $(a.grid.cDiv).outerHeight() : 0,
                            ...
                            var
                                k = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
                            if (a.p.groupHeader) {
                                ...
                                $("tr.jqg-second-row-header th", k).each(function() {
                                    return l = parseInt($(this).attr("colspan"), 10), m = parseInt($(this).attr("rowspan"), 10), m && (n++, o++), l && (n += l, o++), n === e ? (o = e, !1) : void
                                        0
                            ...
                            if ($(k).width(1), $.jgrid.msie() || $(k).css("height", "100%"), $(a.grid.fhDiv).append(k).mousemove(function(b) {
                                    return a.grid.resizing ? (a.grid.dragMove(b), !1) : void
                                        0
                                }), a.p.footerrow) {
                                var
                                    p = $(".ui-jqgrid-bdiv", "#gview_" + $.jgrid.jqID(a.p.id)).height();
                                ...
                                var
                                    q = $(".ui-jqgrid-ftable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
                                $("tr", q).each(function() {
                                    $("td:gt(" + e + ")", this).remove()
                            ...
                            $(a).on("jqGridResizeStop.setFrozenColumns", function(b, c, d) {
                                var
                                    e = $(".ui-jqgrid-htable", a.grid.fhDiv);
                                $("th:eq(" + d + ")", e).width(c);
                                var
                                    f = $(".ui-jqgrid-btable", a.grid.fbDiv);
                                if ($("tr:first td:eq(" + d + ")", f).width(c), a.p.footerrow) {
                                    var
                                        g = $(".ui-jqgrid-ftable", a.grid.fsDiv);
                            ...
                            }), a.p.hoverrows === !0 && $("#" + $.jgrid.jqID(a.p.id)).off("mouseover mouseout"), $(a).on("jqGridAfterGridComplete.setFrozenColumns", function() {
                                $("#" + $.jgrid.jqID(a.p.id) + "_frozen").remove(), $(a.grid.fbDiv).height($(a.grid.bDiv).height() - 14);
                                var
                                    b = [];
                                $("#" + $.jgrid.jqID(a.p.id) + " tr[role=row].jqgrow").each(function() {
                                    b.push($("td:visible:first", this).height())
                                });
                                var
                                ...
                                $("tr[role=row]", c).each(function() {
                                    ...
                                    $("td:not(.jqgrid-rownum):visible:first", this).height(b[a])
                                }), a.p.hoverrows === !0 && ($("tr.jqgrow", c).hover(function() {
        ...
        destroyFrozenColumns: function() {
            return this.each(function() {
                if (this.grid && this.p.frozenColumns === !0) {
                    ...
                    if ($(a.grid.fhDiv).remove(), $(a.grid.fbDiv).remove(), a.grid.fhDiv = null, a.grid.fbDiv = null, a.p.footerrow && ($(a.grid.fsDiv).remove(), a.grid.fsDiv = null), $(this).off(".setFrozenColumns"), a.p.hoverrows === !0) {
                        var
                            c;
...
! function(a) {
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
        ...
        void
            0 !== c.colModel && void
            0 !== c.colModel.formatoptions && (e = a.extend({}, e, c.colModel.formatoptions)), d = e.disabled === !0 ? 'disabled="disabled"' : "", (a.fmatter.isEmpty(b) || void 0 === b) && (b = a.fn.fmatter.defaultFormat(b, e)), b = String(b), b = (b + "").toLowerCase();
        var
            f = b.search(/(false|f|0|no|n|off|undefined)/i) < 0 ? " checked='checked' " : "";
        ...
        if (void 0 !== c.colModel.formatoptions ? (f = c.colModel.formatoptions.value, d = void 0 === c.colModel.formatoptions.separator ? ":" : c.colModel.formatoptions.separator, e = void 0 === c.colModel.formatoptions.delimiter ? ";" : c.colModel.formatoptions.delimiter) : void 0 !== c.colModel.editoptions && (f = c.colModel.editoptions.value, d = void 0 === c.colModel.editoptions.separator ? ":" : c.colModel.editoptions.separator, e = void 0 === c.colModel.editoptions.delimiter ? ";" : c.colModel.editoptions.delimiter), f) {
            var
                h, i = (null != c.colModel.editoptions && c.colModel.editoptions.multiple === !0) == !0 ? !0 : !1,
                j = [];
            if (i && (j = b.split(","), j = a.map(j, function(b) {
                ...
                for (k = 0; k < l.length; k++)
                    ...
                    if (a.trim(h[0]) === a.trim(b)) {
                        g[0] = h[1];
                        break
                    }
            } else
                a.fmatter.isObject(f) && (i ? g = a.map(j, function(a) {
                    return f[a]
                }) : g[0] = f[b] || "")
        }
        ...
        if (void 0 !== h && a.fmatter.isString(h)) {
            var
        ...
        return void
            0 !== f ? f : e === !0 ? a(b).text() : a.jgrid.htmlDecode(a(b).html())
        ...
        if (e === !0) return g;
        var
            h = a.extend({}, void 0 !== c.colModel.formatoptions ? c.colModel.formatoptions : c.colModel.editoptions),
            i = void
...
! function(a) {
    ...
    a.extend(a.jgrid, {
        ...
        hideModal: function(b, c) {
            ...
            var
                d = c.gb && "string" == typeof
                    c.gb && "#gbox_" === c.gb.substr(0, 6) ? a("#" + c.gb.substr(6))[0] : !1;
            if (c.onClose) {
                var
        ...
        createModal: function(b, c, d, e, f, g, h) {
            ...
            a(p).addClass("ui-jqdialog-content " + k.content).attr("id", b.modalcontent), a(p).append(c), m.appendChild(p), a(m).prepend(n), g === !0 ? a("body").append(m) : "string" == typeof
            ...
            if (j && q.left && !g && (t = a(d.gbox).width() - (isNaN(d.width) ? 0 : parseInt(d.width, 10)) - 8, q.left = parseInt(q.left, 10) + parseInt(t, 10)), q.left && (q.left += "px"), a(m).css(a.extend({
                ...
                if (a(n).css("cursor", "move"), a.fn.tinyDraggable) a(m).tinyDraggable({
        ...
        viewModal: function(b, c) {
            ...
            if ("" !== c.gbox && (a(".jqgrid-overlay:first", c.gbox).show(), a(b).data("gbox", c.gbox)), a(b).show().attr("aria-hidden", "false"), c.focusField >= 0) try {
        ...
        info_dialog: function(b, c, d, e) {
            ...
            if (f.buttons.length > 0)
                for (k = 0; k < f.buttons.length; k++) void
            ...
            switch (b) {
                ...
                case "select":
                    ...
                    if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function(b) {
                                ...
                                if ("string" == typeof m && (m = a(a.trim(m)).html()), m) {
                                    if (a(e).append(m), g(e, h, o ? ["postData"] : void 0), void 0 === h.size && (h.size = j ? 3 : 1), j ? (d = f.split(","), d = a.map(d, function(b) {
                                            return a.trim(b)
                                        ...
                                        if ("search" === h.oper) a(i).jqGrid("setColProp", h.name, {
                                            searchoptions: {
                                                dataUrl: null,
                                                value: l
                                            }
                                        ...
                                        if ("filter" === h.oper && a("#fbox_" + i.p.id)[0].p) {
                                            var
                                                n, p = a("#fbox_" + i.p.id)[0].p.columns;
                                            a.each(p, function(a) {
                                                return n = this.index || this.name, h.name === n ? (this.searchoptions.dataUrl = null, this.searchoptions.value = l, !1) : void
                                                    0
                                            })
                                        }
                    ...
                    if (c.value) {
                        ...
                        if ("string" == typeof c.value)
                            for (r = c.value.split(y), q = 0; q < r.length; q++) s = r[q].split(x), s.length > 2 && (s[1] = a.map(s, function(a, b) {
                                return b > 0 ? a : void
                                    0
                            }).join(x)), t = document.createElement("option"), t.setAttribute("role", "option"), t.value = s[0], t.innerHTML = s[1], h.appendChild(t), l || a.trim(s[0]) !== a.trim(d) && a.trim(s[1]) !== a.trim(d) || (t.selected = "selected"), l && (a.inArray(a.trim(s[1]), m) > -1 || a.inArray(a.trim(s[0]), m) > -1) && (t.selected = "selected");
                        else
                        if ("[object Array]" === Object.prototype.toString.call(c.value))
                            for (u = c.value, q = 0; q < u.length; q++) 2 === u[q].length && (v = u[q][0], w = u[q][1], t = document.createElement("option"), t.setAttribute("role", "option"), t.value = v, t.innerHTML = w, h.appendChild(t), l || a.trim(v) !== a.trim(d) && a.trim(w) !== a.trim(d) || (t.selected = "selected"), l && (a.inArray(a.trim(w), m) > -1 || a.inArray(a.trim(v), m) > -1) && (t.selected = "selected"));
                        else
                        if ("object" == typeof c.value) {
                            u = c.value;
                            for (v in
                                u) u.hasOwnProperty(v) && (t = document.createElement("option"), t.setAttribute("role", "option"), t.value = v, t.innerHTML = u[v], h.appendChild(t), l || a.trim(v) !== a.trim(d) && a.trim(u[v]) !== a.trim(d) || (t.selected = "selected"), l && (a.inArray(a.trim(u[v]), m) > -1 || a.inArray(a.trim(v), m) > -1) && (t.selected = "selected"))
                        }
                        g(h, c, ["value"])
                    }
                    break;
                ...
                case "custom":
                    ...
                    try {
                        ...
                        var
                            A = a.jgrid.getRegional(i, "errors"),
    ...
    a.jgrid.extend({
            ...
            return d = a.extend(!0, {
                        ...
                        if (c.length) {
                            ...
                            a.each(s.p.colModel, function() {
                                if (this.name === f && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (u[f] = this.editoptions.custom_value.call(s, a("#" + a.jgrid.jqID(f), A), "get"), void 0 === u[f]) throw "e1"
                                    } catch (c) {
                ...
                f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
                            if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                                ...
                                if (h === d.p.ExpandColumn && d.p.treeGrid === !0) k = a("td[role='gridcell']:eq(" + n + ")", d.rows[r]).text();
                                else {
                                    try {
                                ...
                                var
                                    ...
                                    x = parseInt(w.rowpos, 10) || p + 1,
                                    z = parseInt(2 * (parseInt(w.colpos, 10) || 1), 10);
                                if ("_empty" === c && v.defaultValue && (k = a.isFunction(v.defaultValue) ? v.defaultValue.call(s) : v.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, v, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(m).addClass(g.inputClass), o = !0, F) {
                                    var
                                        A = a(L).find("#" + h);
                                    A.length ? A.replaceWith(m) : o = !1
                                } else {
                                    if (j = a(e).find("tr[rowpos=" + x + "]"), w.rowabove) {
                                        var
                                            B = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + w.rowcontent + "</td></tr>");
                                        a(e).append(B), B[0].rp = x
                                    }
                                    0 === j.length && (j = a("<tr " + l + " rowpos='" + x + "'></tr>").addClass("FormData").attr("id", "tr_" + h), a(j).append(u), a(e).append(j), j[0].rp = x), a("td:eq(" + (z - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void 0 === w.label ? d.p.colNames[n] : w.label) + "</label>"), a("td:eq(" + (z - 1) + ")", j[0]).append(w.elmprefix).append(m).append(w.elmsuffix)
                                }(b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && o && (s.p.savedData[h] = k), "custom" === this.edittype && a.isFunction(v.custom_value) && v.custom_value.call(s, a("#" + h, y), "set", k), a.jgrid.bindEv.call(s, m, v), q[p] = n, p++
                            }
                        }), p > 0) {
                        var
                            v;
                ...
                i(c, d, e) {
                    ...
                    n && (a('td[role="gridcell"]', n).each(function(h) {
                        if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && m[h].editable === !0) {
                            ...
                            switch (s.p.autoencode && (g = a.jgrid.htmlDecode(g)), (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (s.p.savedData[f] = g), f = a.jgrid.jqID(f), m[h].edittype) {
                                case "password":
                                case "text":
                                case "button":
                                case "image":
                                ...
                                case "select":
                                    ...
                                    }), (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (g = a("#" + f, e).val(), m[h].editoptions.multiple && (g = g.join(",")), s.p.savedData[f] = g);
                                    break;
                                case "checkbox":
                                    if (g = String(g), m[h].editoptions && m[h].editoptions.value) {
                                        var
                                            k = m[h].editoptions.value.split(":");
                                        k[0] === g ? a("#" + f, e)[s.p.useProp ? "prop" : "attr"]({
                                            checked: !0,
                                            defaultChecked: !0
                                        ...
                                        g = g.toLowerCase(), g.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== g ? (a("#" + f, e)[s.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + f, e)[s.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + f, e)[s.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + f, e)[s.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                                    (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (g = a("#" + f, e).is(":checked") ? a("#" + f, e).val() : a("#" + f, e).attr("offval"), s.p.savedData[f] = g);
                                    break;
                                case "custom":
                                    try {
                                        ...
                                        "e1" === n ? a.jgrid.info_dialog(G.errcap, "function 'custom_value' " + b[a(this)[0]].p.msg.nodefined, a.rp_ge[a(this)[0]].p.bClose, {
                                            styleUI: b[a(this)[0]].p.styleUI
                                        }) : a.jgrid.info_dialog(G.errcap, n.message, a.rp_ge[a(this)[0]].p.bClose, {
                                            styleUI: b[a(this)[0]].p.styleUI
                                        })
                                    }
                            }
                    ...
                    }), l > 0 && (a("#id_g", A).val(c), (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (s.p.savedData[d.p.id + "_id"] = c)))
                }

                function
                j() {
                    a.each(s.p.colModel, function(a, b) {
                        b.editoptions && b.editoptions.NullIfEmpty === !0 && u.hasOwnProperty(b.name) && "" === u[b.name] && (u[b.name] = "null")
                    })
                }
                ...
                k() {
                    var
                        ...
                        o = {},
                        p = s.p.prmNames,
                        q = a(s).triggerHandler("jqGridAddEditBeforeCheckValues", [a(y), w]);
                    q && "object" == typeof
                        q && (u = q), a.isFunction(b[s.p.id].beforeCheckValues) && (q = b[s.p.id].beforeCheckValues.call(s, u, a(y), w), q && "object" == typeof q && (u = q));
                    for (g in
                        u)
                        if (u.hasOwnProperty(g) && (n = a.jgrid.checkValues.call(s, u[g], g), n[0] === !1)) break;
                    if (j(), n[0] && (o = a(s).triggerHandler("jqGridAddEditClickSubmit", [b[s.p.id], u, w]), void 0 === o && a.isFunction(b[s.p.id].onclickSubmit) && (o = b[s.p.id].onclickSubmit.call(s, b[s.p.id], u, w) || {}), n = a(s).triggerHandler("jqGridAddEditBeforeSubmit", [u, a(y), w]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].beforeSubmit) && (n = b[s.p.id].beforeSubmit.call(s, u, a(y), w))), n[0] && !b[s.p.id].processing) {
                        if (b[s.p.id].processing = !0, a("#sData", A + "_2").addClass(h.active), m = b[s.p.id].url || a(s).jqGrid("getGridParam", "editurl"), f = p.oper, e = "clientArray" === m ? s.p.keyName : p.id, u[f] = "_empty" === a.trim(u[s.p.id + "_id"]) ? p.addoper : p.editoper, u[f] !== p.addoper ? u[e] = u[s.p.id + "_id"] : void 0 === u[e] && (u[e] = u[s.p.id + "_id"]), delete u[s.p.id + "_id"], u = a.extend(u, b[s.p.id].editData, o), s.p.treeGrid === !0) {
                            if (u[f] === p.addoper) {
                            ...
                            for (l in
                                s.p.treeReader)
                                if (s.p.treeReader.hasOwnProperty(l)) {
                                    var
                                        t = s.p.treeReader[l];
                        ...
                        var
                            v = a.extend({
                                ...
                                complete: function(g, j) {
                                    var
                                        l;
                                    if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [g, w]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [g, u, w]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].afterSubmit) && (n = b[s.p.id].afterSubmit.call(s, g, u, w))), n[0] === !1) a(".FormError", y).html(n[1]), a(".FormError", y).show();
                                    else
                                    if (s.p.autoencode && a.each(u, function(b, c) {
                                            u[b] = a.jgrid.htmlDecode(c)
                                        }), u[f] === p.addoper ? (n[2] || (n[2] = a.jgrid.randId()), null == u[e] || "_empty" === u[e] || "" == u[e] ? u[e] = n[2] : n[2] = u[e], b[s.p.id].reloadAfterSubmit ? a(s).trigger("reloadGrid") : s.p.treeGrid === !0 ? a(s).jqGrid("addChildNode", n[2], k, u) : a(s).jqGrid("addRowData", n[2], u, d.addedrow), b[s.p.id].closeAfterAdd ? (s.p.treeGrid !== !0 && a(s).jqGrid("setSelection", n[2]), a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
                                        ...
                                        }, 1e3)) : s.p.treeGrid === !0 ? a(s).jqGrid("setTreeRow", u[e], u) : a(s).jqGrid("setRowData", u[e], u), b[s.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(x),
                                            jqm: d.jqModal,
                                            onClose: b[s.p.id].onClose,
                                            removemodal: b[s.p.id].removemodal,
                                            formprop: !b[s.p.id].recreateForm,
                                            form: b[s.p.id].form
                                        })), a.isFunction(b[s.p.id].afterComplete) && (c = g, setTimeout(function() {
                                            a(s).triggerHandler("jqGridAddEditAfterComplete", [c, u, a(y), w]), b[s.p.id].afterComplete.call(s, c, u, a(y), w), c = null
                                        }, 500)), (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (a(y).data("disabled", !1), "_empty" !== s.p.savedData[s.p.id + "_id"]))
                                        for (l in
                                            s.p.savedData) s.p.savedData.hasOwnProperty(l) && u[l] && (s.p.savedData[l] = u[l]);
                        ...
                        if (v.url || b[s.p.id].useDataProxy || (a.isFunction(s.p.dataProxy) ? b[s.p.id].useDataProxy = !0 : (n[0] = !1, n[1] += " " + G.nourl)), n[0])
                            if (b[s.p.id].useDataProxy) {
                                var
                                    z = s.p.dataProxy.call(s, v, "set_" + s.p.id);
                                void
                                    0 === z && (z = [!0, ""]), z[0] === !1 ? (n[0] = !1, n[1] = z[1] || "Error deleting the selected row!") : (v.data.oper === p.addoper && b[s.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
                                    gb: "#gbox_" + a.jgrid.jqID(x),
                                    jqm: d.jqModal,
                                    onClose: b[s.p.id].onClose,
                                    removemodal: b[s.p.id].removemodal,
                    ...
                    n[0] === !1 && (a(".FormError", y).html(n[1]), a(".FormError", y).show())
                }
                ...
                l(b, c) {
                    var
                        d, e = !1;
                    if (e = !(a.isPlainObject(b) && a.isPlainObject(c) && Object.getOwnPropertyNames(b).length === Object.getOwnPropertyNames(c).length), !e)
                        for (d in
                            c)
                ...
                m() {
                    var
                        c = !0;
                    return a(".FormError", y).hide(), b[s.p.id].checkOnUpdate && (u = {}, e(), v = l(u, s.p.savedData), v && (a(y).data("disabled", !0), a(".confirm", "#" + B.themodal).show(), c = !1)), c
                }
                ...
                n() {
                    var
                        b;
                    if ("_empty" !== c && void 0 !== s.p.savedRow && s.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow))
                        for (b = 0; b < s.p.savedRow.length; b++)
                            if (s.p.savedRow[b].id === c) {
                ...
                p() {
                    ...
                    if (s.p.multiselect && b[s.p.id].editselected) {
                        for (var
                                 f = [], g = 0, h = d.length; h > g; g++) - 1 !== a.inArray(d[g], s.p.selarrrow) && f.push(d[g]);
                ...
                if (s.grid && c) {
                    ...
                    var
                        ...
                        E = 0,
                        F = "string" == typeof
                                b[s.p.id].template && b[s.p.id].template.length > 0, G = a.jgrid.getRegional(this, "errors");
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function() {
                        ...
                        }), a(L).append(I), C = a(s).triggerHandler("jqGridAddEditBeforeInitData", [L, w]), void 0 === C && (C = !0), C && a.isFunction(b[s.p.id].beforeInitData) && (C = b[s.p.id].beforeInitData.call(s, L, w)), C !== !1) {
                        n(), f(c, s, I, D);
                        var
                            M = "rtl" === s.p.direction ? !0 : !1,
                            N = M ? "nData" : "pData",
                            O = M ? "pData" : "nData",
                        ...
                        var
                            V = !1;
                        d.closeOnEscape === !0 && (d.closeOnEscape = !1, V = !0);
                        var
                            W;
                        if (F ? (a(L).find("#pData").replaceWith(P), a(L).find("#nData").replaceWith(Q), a(L).find("#sData").replaceWith(R), a(L).find("#cData").replaceWith(S), W = a("<div id=" + z + "></div>").append(L)) : W = a("<div></div>").append(L).append(T), a(L).append("<div class='binfo topinfo bottominfo'>" + b[s.p.id].bottominfo + "</div>"), a.jgrid.createModal(B, W, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(s.p.id), a("#gbox_" + a.jgrid.jqID(s.p.id))[0]), M && (a("#pData, #nData", A + "_2").css("float", "right"), a(".EditButton", A + "_2").css("text-align", "left")), b[s.p.id].topinfo && a(".tinfo", y).show(), b[s.p.id].bottominfo && a(".binfo", y).show(), W = null, T = null, a("#" + a.jgrid.jqID(B.themodal)).keydown(function(c) {
                                var
                                    e = c.target;
                                if (a(y).data("disabled") === !0) return !1;
                                if (b[s.p.id].savekey[0] === !0 && c.which === b[s.p.id].savekey[1] && "TEXTAREA" !== e.tagName) return a("#sData", A + "_2").trigger("click"), !1;
                            ...
                            })), d.saveicon = a.extend([!0, "left", g.icon_save], d.saveicon), d.closeicon = a.extend([!0, "left", g.icon_close], d.closeicon), d.saveicon[0] === !0 && a("#sData", t).addClass("right" === d.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + h.icon_base + " " + d.saveicon[2] + "'></span>"), d.closeicon[0] === !0 && a("#cData", t).addClass("right" === d.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + h.icon_base + " " + d.closeicon[2] + "'></span>"), b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) {
                        ...
                        a(s).triggerHandler("jqGridAddEditInitializeForm", [a(y), w]), a.isFunction(b[s.p.id].onInitializeForm) && b[s.p.id].onInitializeForm.call(s, a(y), w), "_empty" !== c && b[s.p.id].viewPagerButtons ? a("#pData,#nData", t).show() : a("#pData,#nData", t).hide(), a(s).triggerHandler("jqGridAddEditBeforeShowForm", [a(y), w]), a.isFunction(b[s.p.id].beforeShowForm) && b[s.p.id].beforeShowForm.call(s, a(y), w), r(), a("#" + a.jgrid.jqID(B.themodal)).data("onClose", b[s.p.id].onClose), a.jgrid.viewModal("#" + a.jgrid.jqID(B.themodal), {
                            ...
                            return u = {}, a(".FormError", y).hide(), e(), "_empty" === u[s.p.id + "_id"] ? k() : d.checkOnSubmit === !0 ? (v = l(u, s.p.savedData), v ? (a(y).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(B.themodal)).show()) : k()) : k(), !1
                            ...
                            if (c[0] = parseInt(c[0], 10), -1 !== c[0] && c[1][c[0] + 1]) {
                                ...
                                var
                                    e;
                                if (a.isFunction(d.onclickPgButtons) && (e = d.onclickPgButtons.call(s, "next", a(y), c[1][c[0]]), void 0 !== e && e === !1)) return !1;
                            ...
                            if (-1 !== c[0] && c[1][c[0] - 1]) {
                                ...
                                var
                                    e;
                                if (a.isFunction(d.onclickPgButtons) && (e = d.onclickPgButtons.call(s, "prev", a(y), c[1][c[0]]), void 0 !== e && e === !1)) return !1;
                                if (a("#" + a.jgrid.jqID(c[1][c[0] - 1])).hasClass(h.disabled)) return !1;
        ...
        viewGridRow: function(c, d) {
            ...
            return d = a.extend(!0, {
                ...
                if (l.grid && c) {
                    ...
                    var
                        w = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px",
                    ...
                    if (a(l.p.colModel).each(function() {
                        ...
                        f(c, l, z, u);
                        var
                            A = "rtl" === l.p.direction ? !0 : !1,
                            B = A ? "nData" : "pData",
                            C = A ? "pData" : "nData",
                            D = "<a id='" + B + "' class='fm-button " + h.button + "'><span class='" + h.icon_base + " " + g.icon_prev + "'></span></a>",
                            E = "<a id='" + C + "' class='fm-button " + h.button + "'><span class='" + h.icon_base + " " + g.icon_next + "'></span></a>",
                            F = "<a id='cData' class='fm-button " + h.button + "'>" + d.bClose + "</a>";
                        if (v > 0) {
                            var
                                G = [];
                        ...
                        var
                            H = a("<div></div>").append(y).append("<table border='0' class='EditTable' id='" + o + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (A ? E + D : D + E) + "</td><td class='EditButton'>" + F + "</td></tr></tbody></table>");
        ...
        delGridRow: function(c, d) {
            ...
            return d = a.extend(!0, {
                ...
                if (e.grid && c) {
                    var
                        f, i, j, k, l = a.isFunction(b[e.p.id].beforeShowForm),
                        m = a.isFunction(b[e.p.id].afterShowForm),
                        n = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1,
                        o = e.p.id,
                        p = {},
                        q = !0,
                        r = "DelTbl_" + a.jgrid.jqID(o),
                        s = "DelTbl_" + o,
                        t = {
                            themodal: "delmod" + o,
                            modalhead: "delhd" + o,
                    ...
                    if (b[e.p.id].styleUI = e.p.styleUI || "jQueryUI", a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(t.themodal))[0]) {
                        ...
                        var
                            u = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px",
                            v = isNaN(d.datawidth) ? d.datawidth : d.datawidth + "px",
                            w = "<div id='" + s + "' class='formdata' style='width:" + v + ";overflow:auto;position:relative;height:" + u + ";'>";
                        ...
                        var
                            x = "<a id='dData' class='fm-button " + h.button + "'>" + d.bSubmit + "</a>",
                            y = "<a id='eData' class='fm-button " + h.button + "'>" + d.bCancel + "</a>";
                        ...
                        a(".fm-button", "#" + r + "_2").hover(function() {
                            ...
                            if (p = {}, a.isFunction(b[e.p.id].onclickSubmit) && (p = b[e.p.id].onclickSubmit.call(e, b[e.p.id], l) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (g = b[e.p.id].beforeSubmit.call(e, l)), g[0] && !b[e.p.id].processing) {
                                ...
                                for (c in
                                    l) l.hasOwnProperty(c) && (l[c] = a.jgrid.stripPref(e.p.idPrefix, l[c]));
                                ...
                                var
                                    m = a.extend({
                                        ...
                                        complete: function(c, i) {
                                            var
                                                j;
                                            if (a("#dData", "#" + r + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, a.isFunction(b[e.p.id].errorTextFormat) ? g[1] = b[e.p.id].errorTextFormat.call(e, c) : g[1] = i + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (g = b[e.p.id].afterSubmit.call(e, c, f)), g[0] === !1) a("#DelError>td", "#" + r).html(g[1]), a("#DelError", "#" + r).show();
                                            else {
                                                if (b[e.p.id].reloadAfterSubmit && "local" !== e.p.datatype) a(e).trigger("reloadGrid");
                                                    ...
                                                    if (e.p.treeGrid === !0) try {
                                                        ...
                                                        for (j = 0; j < l.length; j++) a(e).jqGrid("delRowData", e.p.idPrefix + l[j]);
                                ...
                                if (m.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (g[0] = !1, g[1] += " " + a.jgrid.getRegional(e, "errors.nourl"))), g[0])
                                    if (b[e.p.id].useDataProxy) {
                                        var
                                            n = e.p.dataProxy.call(e, m, "del_" + e.p.id);
                                        void
                                            0 === n && (n = [!0, ""]), n[0] === !1 ? (g[0] = !1, g[1] = n[1] || "Error deleting the selected row!") : a.jgrid.hideModal("#" + a.jgrid.jqID(t.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(o),
                                            jqm: d.jqModal,
                                            onClose: b[e.p.id].onClose
                                        })
        ...
        GridToForm: function(b, c) {
            return this.each(function() {
                ...
                if (e.grid) {
                    ...
                    if (f)
                        for (d in
                            f) f.hasOwnProperty(d) && (a("[name=" + a.jgrid.jqID(d) + "]", c).is("input:radio") || a("[name=" + a.jgrid.jqID(d) + "]", c).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(d) + "]", c).each(function() {
    ...
    a.fn.jqFilter = function(b) {
        ...
        return this.each(function() {
            if (!this.filter) {
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    for (b = 0; d > b; b++) c = this.p.columns[b], c.stype ? c.inputtype = c.stype : c.inputtype || (c.inputtype = "text"), c.sorttype ? c.searchtype = c.sorttype : c.searchtype || (c.searchtype = "string"), void
                    ...
                    var
                        k = function(b, c) {
                            ...
                            if (a.jgrid && a.jgrid.checkValues) try {
                    ...
                    this.onchange = function() {
                        ...
                        if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='" + f.p.subgroup + "' class='add-group " + j.button + "'/>"), p.on("click", function() {
                            ...
                            r.on("click", function() {
                                for (void 0 === b.rules && (b.rules = []), d = 0; d < f.p.columns.length; d++) {
                                    var
                                        c = void
                                            0 === f.p.columns[d].search ? !0 : f.p.columns[d].search, e = f.p.columns[d].hidden === !0, g = f.p.columns[d].searchoptions.searchhidden === !0;
                                    if (g && c || c && !e) {
                                        q = f.p.columns[d];
                                        break
                                    }
                        ...
                        var
                            w = f.p.ruleButtons && f.p.uniqueSearchFields;
                        if (w)
                            for (var
                                     x = 0; x < f.p.columns.length; x++) f.p.columns[x].inlist && (f.p.columns[x].search = !0);
                        if (void 0 !== b.rules)
                            for (d = 0; d < b.rules.length; d++)
                                if (g.append(this.createTableRowForRule(b.rules[d], b)), w)
                                    for (var
                                             y = b.rules[d].field, x = 0; x < f.p.columns.length; x++)
                                        if (y === f.p.columns[x].name) {
                                            f.p.columns[x].search = !1;
                                            break
                                        }
                        return g
                        ...
                        r.append(t), t.on("change", function() {
                            ...
                            if (l) {
                                ...
                                for (u = [], a.each(n.p.ops, function() {
                                    u.push(this.oper)
                                }), d = 0; d < h.length; d++) s = a.inArray(h[d], u), -1 !== s && (0 === m && (b.op = n.p.ops[s].oper), j += "<option value='" + n.p.ops[s].oper + "'>" + n.p.ops[s].text + "</option>", m++);
                        ...
                        for (d = 0; d < n.p.columns.length; d++) {
                            var
                                w = void
                                    0 === n.p.columns[d].search ? !0 : n.p.columns[d].search, x = n.p.columns[d].hidden === !0, y = n.p.columns[d].searchoptions.searchhidden === !0;
                        ...
                        var
                            A = a.jgrid.createEl.call(o, l.inputtype, l.searchoptions, b.data, !0, n.p.ajaxSelectOptions || {}, !0);
                        ("nu" === b.op || "nn" === b.op) && (a(A).attr("readonly", "true"), a(A).attr("disabled", "true"));
                        var
                            B = a("<select class='selectopts " + i.srSelect + "'></select>");
                        for (z.append(B), B.on("change", function() {
                        ...
                        B.append(q);
                        var
                            C = a("<td class='data'></td>");
                        p.append(C), C.append(A), a.jgrid.bindEv.call(o, A, l.searchoptions), a(A).addClass("input-elm " + i.srInput).on("change", function() {
                        ...
                        if (p.append(D), this.p.ruleButtons === !0) {
                            var
                                E = a("<input type='button' value='-' title='" + n.p.delrule + "' class='delete-rule ui-del " + j.button + "'/>");
                            D.append(E), E.on("click", function() {
                        ...
                        return void
                            0 === d ? "" : (g = b.data, ("bw" === i || "bn" === i) && (g += "%"), ("ew" === i || "en" === i) && (g = "%" + g), ("cn" === i || "nc" === i) && (g = "%" + g + "%"), ("in" === i || "ni" === i) && (g = " (" + g + ")"), e.errorcheck && k(b.data, d), f = -1 !== a.inArray(d.searchtype, j) || "nn" === i || "nu" === i ? b.field + " " + h + " " + g : b.field + " " + h + ' "' + g + '"')
            ...
            return b = a.extend({
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var
                        ...
                        k = function() {
                            ...
                            a.each(d.p.colModel, function() {
                                var
                                    n = a("#gs_" + d.p.idPrefix + a.jgrid.jqID(this.name), this.frozen === !0 && d.p.frozenColumns === !0 ? d.grid.fhDiv : d.grid.hDiv);
                                if (e = this.index || this.name, g = this.searchoptions || {}, f = b.searchOperators && g.searchOperMenu ? n.parent().prev().children("a").attr("soper") || b.defaultSearch : g.sopt ? g.sopt[0] : "select" === this.stype ? "eq" : b.defaultSearch, c = "custom" === this.stype && a.isFunction(g.custom_value) && n.length > 0 && "SPAN" === n[0].nodeName.toUpperCase() ? g.custom_value.call(d, n.children(".customelement:first"), "get") : n.val(), "select" === this.stype && g.multiple && a.isArray(c) && c.length && (k = !0, l.push(e), c = 1 === c.length ? c[0] : c), "bt" === f && (m = !0), c || "nu" === f || "nn" === f) h[e] = c, j[e] = f, i++;
                                else
                                    try {
                                        delete
                                            d.p.postData[e]
                            ...
                            if (b.stringResult === !0 || "local" === d.p.datatype || b.searchOperators === !0) {
                                ...
                                var
                                    q, r, s, t, u, v, w;
                                if (k && (q = a.jgrid.parse(o), q.rules && q.rules.length))
                                    for (r = q.rules, s = 0; s < r.length; s++) u = r[s], a.inArray(u.filed, l) && (v = u.data.split(b.splitSelect), v.length > 1 && (void 0 === q.groups && (q.groups = []), w = {
                                        groupOp: b.groupOpSelect,
                                        groups: [],
                                        rules: []
                                    }, q.groups.push(w), a.each(v, function(a) {
                                        t = v[a], t && w.rules.push({
                                            data: v[a],
                                            op: u.op,
                                            field: u.field
                                        })
                                    }), r.splice(s, 1), s--));
                                if (m && (a.isPlainObject(q) || (q = a.jgrid.parse(o)), q.rules && q.rules.length))
                                    for (r = q.rules, s = 0; s < r.length; s++) u = r[s], "bt" === u.op && (v = u.data.split("..."), v.length > 1 && (void 0 === q.groups && (q.groups = []), w = {
                                        groupOp: "AND",
                                        groups: [],
                                        rules: []
                                    }, q.groups.push(w), a.each(v, function(a) {
                                ...
                                a.extend(d.p.postData, h);
                            var
                                x;
                            d.p.searchurl && (x = d.p.url, a(d).jqGrid("setGridParam", {
                                url: d.p.searchurl
                            }));
                            var
                                y = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1;
                        ...
                        l = function(c) {
                            var
                                ...
                                g = 0;
                            c = "boolean" != typeof
                                c ? !0 : c, a.each(d.p.colModel, function() {
                                var
                                    b, c = a("#gs_" + d.p.idPrefix + a.jgrid.jqID(this.name), this.frozen === !0 && d.p.frozenColumns === !0 ? d.grid.fhDiv : d.grid.hDiv);
                                switch (this.searchoptions && void 0 !== this.searchoptions.defaultValue && (b = this.searchoptions.defaultValue), e = this.index || this.name, this.stype) {
                                    case "select":
                                        if (c.find("option").each(function(c) {
                                                return 0 === c && (this.selected = !0), a(this).val() === b ? (this.selected = !0, !1) : void
                                                    0
                                            }), void 0 !== b) f[e] = b, g++;
                                        else
                                            try {
                            ...
                            var
                                l = "stop" === a(d).triggerHandler("jqGridToolbarBeforeClear") ? !0 : !1;
                        ...
                        n = function(c, e, f) {
                            ...
                            for (var
                                     g, j, l = a(".ui-jqgrid-view").css("font-size") || "11px", m = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + e + "px;top:" + f + 'px;">', n = a(c).attr("soper"), o = [], p = 0, q = a(c).attr("colname"), r = d.p.colModel.length; r > p && d.p.colModel[p].name !== q;) p++;
                            var
                                s = d.p.colModel[p],
                    ...
                    b.restoreFromFilters && (g = d.p.postData.filters, g && ("string" == typeof g && (g = a.jgrid.parse(g)), f = g.rules.length ? g.rules : !1)), a.each(d.p.colModel, function(c) {
                        ...
                        if (this.hidden === !0 && a(v).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), this.searchoptions = this.searchoptions || {}, void 0 === this.searchoptions.searchOperMenu && (this.searchoptions.searchOperMenu = !0), g = a.extend({}, this.searchoptions, {
                                name: s.index || s.name,
                            ...
                            if (b.searchOperators) {
                                for (i = g.sopt ? g.sopt[0] : "select" === s.stype ? "eq" : b.defaultSearch, b.restoreFromFilters && r && (i = r.op), l = 0; l < b.odata.length; l++)
                                    if (b.odata[l].oper === i) {
                                        u = b.operands[i] || "";
                                        break
                                    }
                            ...
                            switch (a("td:eq(0)", x).attr("colindex", c).append(t), void 0 === g.clearSearch && (g.clearSearch = !0), g.clearSearch ? (n = b.resetTitle || "Clear Search Value", a("td:eq(2)", x).append("<a title='" + n + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + b.resetIcon + "</a>")) : a("td:eq(2)", x).hide(), this.surl && (g.dataUrl = this.surl), p = "", g.defaultValue && (p = a.isFunction(g.defaultValue) ? g.defaultValue.call(d) : g.defaultValue), b.restoreFromFilters && r && (p = r.data), q = a.jgrid.createEl.call(d, this.stype, g, p, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), a(q).addClass(h.srInput), a("td:eq(1)", x).append(q), a(w).append(x), null == g.dataEvents && (g.dataEvents = []), this.stype) {
                                case "select":
                                    b.autosearch === !0 && g.dataEvents.push({
                                        type: "change",
                                        fn: function() {
                                            return k(), !1
                                        }
                                    ...
                                    break;
                                case "text":
                                    b.autosearch === !0 && (b.searchOnEnter ? g.dataEvents.push({
                                        type: "keypress",
                                        fn: function(a) {
                                            var
                                                b = a.charCode || a.keyCode || 0;
                        ...
                        "select" === d.p.colModel[f].stype ? (c = a("td.ui-search-input select", e), h ? c.val(h) : c[0].selectedIndex = 0) : (c = a("td.ui-search-input input", e), c.val(h)), a(d).triggerHandler("jqGridToolbarClearVal", [c[0], f, g, h]), a.isFunction(b.onClearSearchValue) && b.onClearSearchValue.call(d, c[0], f, g, h), b.autosearch === !0 && k()
        ...
        refreshFilterToolbar: function(b) {
            return b = a.extend(!0, {
                ...
                c(f) {
                    if (f && f.rules) {
                        for (g = f.rules, l = g.length, d = 0; l > d; d++) h = g[d], i = a.inArray(h.field, m), -1 !== i && (e = a("#gs_" + j.p.idPrefix + a.jgrid.jqID(k[i].name)), e.length > 0 && ("select" === k[i].stype ? e.find("option[value='" + a.jgrid.jqID(h.data) + "']").prop("selected", !0) : "text" === k[i].stype && e.val(h.data), a.isFunction(b.onSetVal) && b.onSetVal.call(j, e, k[i].name)));
                        if (f.groups)
                            for (var
                    ...
                    if (b.styleUI = d.p.styleUI, "string" == typeof j && (j = a.jgrid.parse(j)), b.recreateFilter === !0 && a("#" + a.jgrid.jqID(i.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(i.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(d.p.id)));
                        ...
                        if (b.showQuery && (u = "<a id='" + f + "_query' class='fm-button " + l.button + " fm-button-icon-left'><span class='" + l.icon_base + " " + k.icon_query + "'></span>Query</a>"), b.columns.length ? (r = b.columns, x = 0, p = r[0].index || r[0].name) : a.each(r, function(a, b) {
                                if (b.label || (b.label = d.p.colNames[a]), !w) {
                                    var
                                        c = void
                                            0 === b.search ? !0 : b.search, e = b.hidden === !0, f = b.searchoptions && b.searchoptions.searchhidden === !0;
                        ...
                        w = !1, b.tmplNames && b.tmplNames.length && (w = !0, v = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", v += "<td><select class='ui-template " + k.srSelect + "'>", v += "<option value='default'>Default</option>", a.each(b.tmplNames, function(a, b) {
                        ...
                        }), b.multipleGroup === !0 && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [a("#" + f)]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + f)), b.gbox = "#gbox_" + f, b.layer ? a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                            position: "relative"
                            ...
                            if (b.stringResult) {
                                ...
                                b.multipleSearch ? (j[b.sFilter] = g, a.each([b.sField, b.sValue, b.sOper], function() {
                                    j[this] = ""
                            ...
                            return d.p.search = !0, a.extend(d.p.postData, j), h = a(d).triggerHandler("jqGridFilterSearch"), void
                                0 === h && (h = !0), h && a.isFunction(b.onSearch) && (h = b.onSearch.call(d, d.p.filters)), h !== !1 && a(d).trigger("reloadGrid", [{
                                page: 1
                            ...
                            var
                                c = {},
                                e = a("#" + f);
                            return d.p.search = !1, d.p.resetsearch = !0, b.multipleSearch === !1 ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", e[0].resetFilter(), w && a(".ui-template", m).val("default"), a.extend(d.p.postData, c), h = a(d).triggerHandler("jqGridFilterReset"), void
                                0 === h && (h = !0), h && a.isFunction(b.onReset) && (h = b.onReset.call(d)), h !== !1 && a(d).trigger("reloadGrid", [{
                                page: 1
            ...
            return c = a.extend(!0, {
                ...
                if (d.grid) {
                    ...
                    if (b += "", "local" !== !d.p.datatype) {
                        a.each(d.p.colModel, function() {
                            e = this.index || this.name, f = this.searchoptions || {}, g = c.defaultSearch ? c.defaultSearch : f.sopt ? f.sopt[0] : c.defaultSearch, this.search = this.search === !1 ? !1 : !0, (this.search || c.searchAll) && (i > 0 && (h += ","), h += '{"field":"' + e + '",', h += '"op":"' + g + '",', h += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', i++)
                        ...
                        var
                            j = "stop" === a(d).triggerHandler("jqGridFilterInputBeforeSearch") ? !0 : !1;
        ...
        editRow: function(b, c, d, e, f, g, h, i, j) {
            ...
            return "object" === a.type(l[0]) ? k = l[0] : (void 0 !== c && (k.keys = c), a.isFunction(d) && (k.oneditfunc = d), a.isFunction(e) && (k.successfunc = e), void 0 !== f && (k.url = f), void 0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)), k = a.extend(!0, {
                ...
                var
                    ...
                    l = null,
                    m = {},
                    n = a(this).jqGrid("getStyleUI", i.p.styleUI + ".inlinedit", "inputClass", !0);
                if (i.grid && (f = a(i).jqGrid("getInd", b, !0), f !== !1)) {
                    if (i.p.beforeAction = !0, h = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(i, k, b) : void 0, void 0 === h && (h = !0), !h) return void(i.p.beforeAction = !1);
                    e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = i.p.colModel, a('td[role="gridcell"]', f).each(function(e) {
                        c = g[e].name;
                        var
                            f = i.p.treeGrid === !0 && c === i.p.ExpandColumn;
                        ...
                        if ("cb" !== c && "subgrid" !== c && "rn" !== c && (i.p.autoencode && (d = a.jgrid.htmlDecode(d)), m[c] = d, g[e].editable === !0)) {
                            ...
                            var
                                o = a.jgrid.createEl.call(i, g[e].edittype, k, d, !0, a.extend({}, a.jgrid.ajaxOptions, i.p.ajaxSelectOptions || {}));
                            a(o).addClass("editable inline-edit-cell"), a.inArray(g[e].edittype, ["text", "textarea", "password", "select"]) > -1 && a(o).addClass(n), f ? a("span:first", this).append(o) : a(this).append(o), a.jgrid.bindEv.call(i, o, k), "select" === g[e].edittype && void
                                0 !== g[e].editoptions && g[e].editoptions.multiple === !0 && void
                                0 === g[e].editoptions.dataUrl && a.jgrid.msie() && a(o).width(a(o).width()), j++
                        }
                        ...
                        var
                            b = a("td:eq(" + l + ") :input:visible", f).not(":disabled");
                        b.length > 0 && b.focus()
                    }, 0)), k.keys === !0 && a(f).on(k.keyevent, function(c) {
                        if (27 === c.keyCode) {
            ...
            if (void 0 === y && (y = !0), y) {
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (a('td[role="gridcell"]', p).each(function(b) {
                            if (z = k.p.colModel[b], l = z.name, B = "", "cb" !== l && "subgrid" !== l && z.editable === !0 && "rn" !== l && !a(this).hasClass("not-editable-cell")) {
                                switch (z.edittype) {
                                    case "checkbox":
                                        var
                                            c = ["Yes", "No"];
                                        z.editoptions && (c = z.editoptions.value.split(":")), r[l] = a("input", this).is(":checked") ? c[0] : c[1], B = a("input", this);
                                        break;
                                    case "text":
                                    case "password":
                                    case "textarea":
                                    ...
                                    case "select":
                                        if (z.editoptions.multiple) {
                                            ...
                                            r[l] = a("select option:selected", this).val(), s[l] = a("select option:selected", this).text();
                                    ...
                                    case "custom":
                                        try {
                                            ...
                                            "e1" === f ? a.jgrid.info_dialog(w.errcap, "function 'custom_value' " + x.msg.nodefined, x.bClose, {
                                                styleUI: k.p.styleUI
                                            }) : a.jgrid.info_dialog(w.errcap, f.message, x.bClose, {
                                                styleUI: k.p.styleUI
                                            })
                                        }
                                }
                                if (o = a.jgrid.checkValues.call(k, r[l], b), o[0] === !1) return A = b, !1;
                    ...
                    var
                        F, G = k.p.prmNames,
                        H = b;
                    if (F = k.p.keyName === !1 ? G.id : k.p.keyName, r) {
                        if (r[G.oper] = G.editoper, void 0 === r[F] || "" === r[F]) r[F] = b;
                        else
                        if (p.id !== k.p.idPrefix + r[F]) {
                            var
                                I = a.jgrid.stripPref(k.p.idPrefix, b);
                            if (void 0 !== k.p._index[I] && (k.p._index[r[F]] = k.p._index[I], delete k.p._index[I]), b = k.p.idPrefix + r[F], a(p).attr("id", b), k.p.selrow === H && (k.p.selrow = b), a.isArray(k.p.selarrrow)) {
                                var
                                    J = a.inArray(H, k.p.selarrrow);
                                J >= 0 && (k.p.selarrrow[J] = b)
                            }
                            if (k.p.multiselect) {
                                var
                                    K = "jqg_" + k.p.id + "_" + b;
                                a("input.cbox", p).attr("id", K).attr("name", K)
                            }
                        }
                        void
                    ...
                    if ("clientArray" === j.url) {
                        ...
                        var
                            L, M = a(k).jqGrid("setRowData", b, r);
                        for (a(p).attr("editable", "0"), L = 0; L < k.p.savedRow.length; L++)
                            if (String(k.p.savedRow[L].id) === String(H)) {
                                n = L;
                                break
                            }
                        n >= 0 && k.p.savedRow.splice(n, 1), a(k).triggerHandler("jqGridInlineAfterSaveRow", [b, M, r, j]), a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(k, b, M, r, j), q = !0, a(p).removeClass("jqgrid-new-row").off("keydown")
                    } else
                        a(k).jqGrid("progressBar", {
                            method: "show",
                            loadtype: j.saveui,
                            htmlcontent: j.savetext
                        }), t = a.extend({}, r, t), t[F] = a.jgrid.stripPref(k.p.idPrefix, t[F]), a.ajax(a.extend({
                            url: j.url,
                                ...
                                if (a(k).jqGrid("progressBar", {
                                    ...
                                    if (e = a(k).triggerHandler("jqGridInlineSuccessSaveRow", [c, b, j]), a.isArray(e) || (e = [!0, t]), e[0] && a.isFunction(j.successfunc) && (e = j.successfunc.call(k, c)), a.isArray(e) ? (g = e[0], r = e[1] || r) : g = e, g === !0) {
                                        for (k.p.autoencode && a.each(r, function(b, c) {
                                            ...
                                            "null" === r[a] && (r[a] = "")
                                        }), r = a.extend({}, r, s), a(k).jqGrid("setRowData", b, r), a(p).attr("editable", "0"), f = 0; f < k.p.savedRow.length; f++)
                                            if (String(k.p.savedRow[f].id) === String(b)) {
                                                n = f;
                                                break
                                            }
                                        ...
                                        a(k).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, null, j]), a.isFunction(j.errorfunc) && j.errorfunc.call(k, b, c, d, null), j.restoreAfterError === !0 && a(k).jqGrid("restoreRow", b, j.afterrestorefunc)
                                }
                            },
                ...
                if (this.grid) {
                    ...
                    var
                        d = a.isFunction(b.beforeAddRow) ? b.beforeAddRow.call(c, b.addRowParams) : void
                            0;
                    if (void 0 === d && (d = !0), !d) return void(c.p.beforeAction = !1);
                ...
                if (this.grid && !this.p.inlineNav) {
                    ...
                    if (d.p.navGrid || a(d).jqGrid("navGrid", b, {
                        ...
                        for (h = 0; h < i.length; h++)
                            if (i[h].formatter && "actions" === i[h].formatter) {
                    ...
                    c.add && a(d).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function() {
                            ...
                            b ? (void 0 === d.p.beforeAction && (d.p.beforeAction = !0), a(d).jqGrid("editRow", b, c.editParams), d.p.beforeAction && (a("#" + f + "_ilsave").removeClass(g), a("#" + f + "_ilcancel").removeClass(g), a("#" + f + "_iladd").addClass(g), a("#" + f + "_iledit").addClass(g))) : (a.jgrid.viewModal("#alertmod_" + f, {
                                gbox: "#gbox_" + f,
                                jqm: !0
                            }), a("#jqg_alrt").focus())
                        }
                    ...
                    }), a("#" + f + "_ilcancel").addClass(g)), (c.restoreAfterSelect === !0 || c.saveAfterSelect === !0) && a(d).on("jqGridBeforeSelectRow.inlineNav", function(b, e) {
                        d.p.savedRow.length > 0 && d.p.inlineNav === !0 && e !== d.p.selrow && null !== d.p.selrow && (d.p.selrow === c.addParams.rowID ? a(d).jqGrid("delRowData", d.p.selrow) : c.restoreAfterSelect === !0 ? a(d).jqGrid("restoreRow", d.p.selrow, c.editParams) : a(d).jqGrid("saveRow", d.p.selrow, c.editParams), a(d).jqGrid("showAddEditButtons"))
                    })
                }
            })
        },
            ...
            return this.each(function() {
                ...
                if (i.grid && i.p.cellEdit === !0) {
                    ...
                    if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                        ...
                        if (h.editable !== !0 || d !== !0 || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c)) parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j), g.addClass("edit-cell " + j), a(i.rows[b]).addClass("selected-row " + k), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c);
                        else {
                            ...
                            if (i.p.autoencode && (f = a.jgrid.htmlDecode(f)), h.edittype || (h.edittype = "text"), i.p.savedRow.push({
                                ...
                                var
                                    o = i.p.formatCell.call(i, i.rows[b].id, e, f, b, c);
                                void
                                    0 !== o && (f = o)
                            }
                            ...
                            var
                                ...
                                q = a.jgrid.createEl.call(i, h.edittype, p, f, !0, a.extend({}, a.jgrid.ajaxOptions, i.p.ajaxSelectOptions || {}));
                            a.inArray(h.edittype, ["text", "textarea", "password", "select"]) > -1 && a(q).addClass(l), g.html("").append(q).attr("tabindex", "0"), a.jgrid.bindEv.call(i, q, p), window.setTimeout(function() {
                                a(q).focus()
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        switch (k.edittype) {
                            case "select":
                                if (k.editoptions.multiple) {
                                    ...
                                    h = a("#" + b + "_" + m + " option:selected", e.rows[b]).val(), i = a("#" + b + "_" + m + " option:selected", e.rows[b]).text();
                                k.formatter && (i = h);
                                break;
                            case "checkbox":
                                var
                            ...
                            case "custom":
                                try {
                                    ...
                                    "e1" === r ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.nodefined, g.bClose, {
                                        styleUI: e.p.styleUI
                                    }) : "e2" === r ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.novalue, g.bClose, {
                                        styleUI: e.p.styleUI
                                    }) : a.jgrid.info_dialog(f.errcap, r.message, g.bClose, {
                                        styleUI: e.p.styleUI
                                    })
                                }
                        }
                        if (i !== e.p.savedRow[d].v) {
                            var
                                s = a(e).triggerHandler("jqGridBeforeSaveCell", [e.rows[b].id, l, h, b, c]);
                            if (s && (h = s, i = s), a.isFunction(e.p.beforeSaveCell)) {
                                var
                                    t = e.p.beforeSaveCell.call(e, e.rows[b].id, l, h, b, c);
                                t && (h = t, i = t)
                            }
                            var
                                u = a.jgrid.checkValues.call(e, h, c),
                                v = !1;
                            if (u[0] === !0) {
                                var
                                    w = a(e).triggerHandler("jqGridBeforeSubmitCell", [e.rows[b].id, l, h, b, c]) || {};
                                if (a.isFunction(e.p.beforeSubmitCell) && (w = e.p.beforeSubmitCell.call(e, e.rows[b].id, l, h, b, c), w || (w = {})), a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit)
                                    if (e.p.cellurl) {
                                        var
                                            x = {};
                                        e.p.autoencode && (h = a.jgrid.htmlEncode(h)), k.editoptions && k.editoptions.NullIfEmpty && "" === h && (h = "null", v = !0), x[l] = h;
                                        var
                                            y, z, A;
                                        A = e.p.prmNames, y = A.id, z = A.oper, x[y] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id), x[z] = A.editoper, x = a.extend(w, x), a(e).jqGrid("progressBar", {
                                            method: "show",
                                            loadtype: e.p.loadui,
                                ...
                                try {
                                    a.isFunction(e.p.validationCell) ? e.p.validationCell.call(e, a("#" + b + "_" + m, e.rows[b]), u[1], b, c) : (window.setTimeout(function() {
            ...
            return this.each(function() {
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    for (d = c + 1; d < e.p.colModel.length; d++)
                        if (e.p.colModel[d].editable === !0 && (!a.isFunction(e.p.isCellEditable) || e.p.isCellEditable.call(e, e.p.colModel[d].name, b, d))) {
                            f = d;
                            break
                        }
    ...
    a.fn.jqm = function(d) {
        ...
        open: function(b, g) {
            ...
            if (i.t = g, i.a = !0, i.w.css("z-index", l), j.modal ? (d[0] || setTimeout(function() {
                ...
                k && i.w.jqmAddClose(a(k, i.w));
            return j.toTop && i.o && i.w.before('<span id="jqmP' + i.w[0]._jqm + '"></span>').insertAfter(i.o), j.onShow ? j.onShow(i) : i.w.show(), f(i), e
        },
        close: function(b) {
            var
                f = c[b];
            return f.a ? (f.a = e, d[0] && (d.pop(), d[0] || new h("unbind")), f.c.toTop && f.o && a("#jqmP" + f.w[0]._jqm).after(f.w).remove(), f.c.onHide ? f.c.onHide(f) : (f.w.hide(), f.o && f.o.remove()), e) : e
        },
        params: {}
    };
    var
        ...
        i = function(b) {
            ...
            return f && (a(".jqmID" + e.s).each(function() {
                var
                    c = a(this),
                    d = c.offset();
                return d.top <= b.pageY && b.pageY <= d.top + c.height() && d.left <= b.pageX && b.pageX <= d.left + c.width() ? (f = !1, !1) : void
                    0
            }), g(e)), !f
        },
        j = function(b, d, f) {
                ...
                a(d).each(function() {
                    this[f] || (this[f] = [], a(this).click(function() {
                        for (var
                            ...
                            for (var
                                b in
                                this[a]) c[this[a][b]] && c[this[a][b]].w[a](this);
                        return e
                    })), this[f].push(b)
                })
            })
        ...
        addSubGrid: function(b, c) {
            return this.each(function() {
                ...
                if (d.grid) {
                    ...
                    for (void 0 !== c && c > 0 && (s = c, r = c + 1); r > s;) {
                        if (a(d.rows[s]).hasClass("jqgrow")) {
                            if (d.p.scroll && a(d.rows[s].cells[b]).off("click"), q = null, t) var
                                q = d.p.isHasSubGrid.call(d, d.rows[s].id);
                            q === !1 ? d.rows[s].cells[b].innerHTML = "" : a(d.rows[s].cells[b]).on("click", function() {
                                var
                                ...
                                if (a(this).hasClass("sgexpanded")) {
                                    ...
                                    d.p.subGridOptions.reloadOnExpand === !0 ? i.remove(".ui-subgrid") : i.hasClass("ui-subgrid") && i.hide().addClass("ui-sg-collapsed").removeClass("ui-sg-expanded"), a(this).html("<a style='cursor:pointer;' class='ui-sghref'><span class='" + k.icon_base + " " + d.p.subGridOptions.plusicon + "'></span></a>").removeClass("sgexpanded").addClass("sgcollapsed"), d.p.subGridOptions.selectOnCollapse && a(d).jqGrid("setSelection", e)
                                }
                                return !1
                            })
                        }
    ...
    a.jgrid.extend({
        groupingSetup: function() {
            return this.each(function() {
                ...
                if (g.plusicon || (g.plusicon = h.icon_plus), g.minusicon || (g.minusicon = h.icon_minus), g.groupField.length) {
                    for (void 0 === g.visibiltyOnNextGrouping && (g.visibiltyOnNextGrouping = []), g.lastvalues = [], g._locgr || (g.groups = []), g.counters = [], b = 0; b < g.groupField.length; b++) g.groupOrder[b] || (g.groupOrder[b] = "asc"), g.groupText[b] || (g.groupText[b] = "{0}"), "boolean" != typeof
                        g.groupColumnShow[b] && (g.groupColumnShow[b] = !0), "boolean" != typeof
                        g.groupSummary[b] && (g.groupSummary[b] = !1), g.groupSummaryPos[b] || (g.groupSummaryPos[b] = "footer"), g.groupColumnShow[b] === !0 ? (g.visibiltyOnNextGrouping[b] = !0, a(e).jqGrid("showCol", g.groupField[b])) : (g.visibiltyOnNextGrouping[b] = a("#" + a.jgrid.jqID(e.p.id + "_" + g.groupField[b])).is(":visible"), a(e).jqGrid("hideCol", g.groupField[b]));
        ...
        groupingPrepare: function(b, c) {
            return this.each(function() {
                var
                    ...
                    m = 0;
                for (d = 0; l > d; d++) e = i.groupField[d], g = i.displayField[d], f = b[e], h = null == g ? null : b[g], null == h && (h = f), void
                    ...
                    o = function(b) {
                        var
                            c = a.map(b.split(" "), function(a) {
                                return a.substring(0, i.length + 1) === i + "_" ? parseInt(a.substring(i.length + 1), 10) : void
                                    0
                            });
        ...
        groupingRender: function(b, c, d, e) {
            return this.each(function() {
                ...
                u.reverse(), s = k.p.multiselect ? ' colspan="2"' : "", a.each(l.groups, function(f, v) {
                    ...
                    var
                        x = "";
                    x = a.isFunction(l.groupText[v.idx]) ? l.groupText[v.idx].call(k, j, v.cnt, v.summary) : a.jgrid.template(l.groupText[v.idx], j, v.cnt, v.summary), "string" != typeof
                        x && "number" != typeof
                    ...
                    if (y) {
                        var
                            ...
                            D = v.startRow,
                            E = void
                                0 !== B ? B.startRow : l.groups[f].startRow + l.groups[f].cnt;
            ...
            return b = a.extend({
                ...
                for (a(q).prepend(x), e = a("<tr>", {
                    ...
                    if (g = u[c].el, h = a(g), d = s[c], i = {
                        ...
                        0 === r ? b.useColSpanStyle ? h.attr("rowspan", "2") : (a("<th>", {
                            role: "columnheader"
    ...
    a.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (d.grid && d.p.treeGrid) {
                    var
                        ...
                        t = b;
                    for (a(d).triggerHandler("jqGridBeforeSetTreeNode", [t, c]), a.isFunction(d.p.beforeSetTreeNode) && d.p.beforeSetTreeNode.call(d, t, c); c > b;) {
                        var
                            u, v = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id),
                            w = d.p._index[v];
                        k = d.p.data[w], "nested" === d.p.treeGridModel && (k[o] || (e = parseInt(k[d.p.treeReader.left_field], 10), f = parseInt(k[d.p.treeReader.right_field], 10), k[o] = f === e + 1 ? "true" : "false", d.rows[b].cells[d.p._treeleafpos].innerHTML = k[o])), g = parseInt(k[p], 10), 0 === d.p.tree_root_level ? (h = g + 1, i = g) : (h = g, i = g - 1), j = "<div class='tree-wrap tree-wrap-" + d.p.direction + "' style='width:" + 18 * h + "px;'>", j += "<div style='" + ("rtl" === d.p.direction ? "right:" : "left:") + 18 * i + "px;' class='" + s.icon_base + " ", void
                            0 !== k[r] && ("true" === k[r] || k[r] === !0 ? k[r] = !0 : k[r] = !1), "true" === k[o] || k[o] === !0 ? (j += (void 0 !== k[q] && "" !== k[q] ? k[q] : d.p.treeIcons.leaf) + " tree-leaf treeclick", k[o] = !0, l = "leaf") : (k[o] = !1, l = ""), k[n] = ("true" === k[n] || k[n] === !0 ? !0 : !1) && (k[r] || void 0 === k[r]), j += k[n] === !1 ? k[o] === !0 ? "'" : d.p.treeIcons.plus + " tree-plus treeclick'" : k[o] === !0 ? "'" : d.p.treeIcons.minus + " tree-minus treeclick'", j += "></div></div>", a(d.rows[b].cells[m]).wrapInner("<span class='cell-wrapper" + l + "'></span>").prepend(j), g !== parseInt(d.p.tree_root_level, 10) && (u = a(d).jqGrid("isVisibleNode", k), u || a(d.rows[b]).css("display", "none")), a(d.rows[b].cells[m]).find("div.treeclick").on("click", function(b) {
                            var
                        ...
                        }), d.p.ExpandColClick === !0 && a(d.rows[b].cells[m]).find("span.cell-wrapper").css("cursor", "pointer").on("click", function(b) {
                            var
                                c = b.target || b.srcElement,
                                e = a.jgrid.stripPref(d.p.idPrefix, a(c, d.rows).closest("tr.jqgrow")[0].id),
                                f = d.p._index[e];
                ...
                if (f.p.treeGrid) {
                    ...
                    for (d in
                        ...
                        if (f.p.colModel.hasOwnProperty(d)) {
                            ...
                            for (e in
                                f.p.treeReader) f.p.treeReader.hasOwnProperty(e) && f.p.treeReader[e] === c && i.push(c)
                        }
            ...
            this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) {
                    var
                        ...
                        g = a.isFunction(c.p.beforeExpandTreeGridRow) ? c.p.beforeExpandTreeGridRow.call(c, f, b, d) : !0;
            ...
            this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) {
                    var
                        ...
                        e = c.p.treeReader.expanded_field,
                        f = b[c.p.localReader.id],
                        g = a.isFunction(c.p.beforeCollapseTreeGridRow) ? c.p.beforeCollapseTreeGridRow.call(c, f, b, d) : !0;
                    g !== !1 && (a(d).each(function() {
                        var
                            b = c.p.idPrefix + a.jgrid.getAccessor(this, c.p.localReader.id);
                ...
                if (d.grid && d.p.treeGrid) switch (d.p.treeGridModel) {
                    case "nested":
                        ...
                        a(this.p.data).each(function() {
                            return parseInt(this[g], 10) === j - 1 && parseInt(this[e], 10) < h && parseInt(this[f], 10) > i ? (c = this, !1) : void
                                0
                        });
                        break;
                    case "adjacency":
                        for (var
                                 k = d.p.treeReader.parent_id_field, l = d.p.localReader.id, m = b[l], n = d.p._index[m]; n--;)
                            if (d.p.data[n][l] === a.jgrid.stripPref(d.p.idPrefix, b[k])) {
                                c = d.p.data[n];
                                break
                            }
                }
                    ...
                    switch (e.p.treeGridModel) {
                        case "nested":
                            var
                                ...
                                m = parseInt(b[j], 10),
                                n = parseInt(b[k], 10);
                            for (f = 0; h > f; f++) g = c ? e.p.data[e.p._index[this.rows[f].id]] : e.p.data[f], g && parseInt(g[k], 10) === n + 1 && parseInt(g[i], 10) > l && parseInt(g[j], 10) < m && d.push(g);
                            break;
                        case "adjacency":
                            var
                                o = e.p.treeReader.parent_id_field,
                                p = e.p.localReader.id;
                            for (f = 0; h > f; f++) g = c ? e.p.data[e.p._index[this.rows[f].id]] : e.p.data[f], g && String(g[o]) === a.jgrid.stripPref(e.p.idPrefix, b[p]) && d.push(g)
                    }
                }
            }), d
        },
                    ...
                    case "adjacency":
                        if (b) {
                            ...
                            a(this.p.data).each(function(b) {
                                for (e = d.length, b = 0; e > b; b++)
                                    if (a.jgrid.stripPref(f.p.idPrefix, d[b][o]) === this[n]) {
        ...
        getNodeAncestors: function(b, c, d) {
            ...
            return void
                ...
                if (this.grid && this.p.treeGrid) {
                    d = void
                        0 === d ? !1 : this.p.treeReader.expanded_field;
                    for (var
        ...
        isNodeLoaded: function(b) {
            ...
            return this.each(function() {
                ...
                if (d.grid && d.p.treeGrid) {
                    ...
                    c = void
                        0 !== b ? void
                        0 !== b[f] ? b[f] : b[e] || a(d).jqGrid("getNodeChildren", b).length > 0 ? !0 : !1: !1
                }
            }), c
        },
        setLeaf: function(b, c, d) {
            return this.each(function() {
                ...
                if (c === !0) a("div.treeclick", f).removeClass(this.p.treeIcons.minus + " tree-minus " + this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.leaf + " tree-leaf");
                else
                if (c === !1) {
                    var
                        j = this.p.treeIcons.minus + " tree-minus";
                    d && (j = this.p.treeIcons.plus + " tree-plus"), a("div.treeclick", f).removeClass(this.p.treeIcons.leaf + " tree-leaf").addClass(j)
                }
            })
        },
        ...
        expandNode: function(b) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!b[c]) {
                        var
                            i = a.jgrid.getAccessor(b, this.p.localReader.id),
                            j = a("#" + this.p.idPrefix + a.jgrid.jqID(i), this.grid.bDiv)[0],
                            k = this.p._index[i],
                            l = a.isFunction(this.p.beforeExpandTreeGridNode) ? this.p.beforeExpandTreeGridNode.call(this, i, b) : !0;
                        if (l === !1) return;
        ...
        collapseNode: function(b) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (b[c]) {
                        var
                            d = a.jgrid.getAccessor(b, this.p.localReader.id),
                            e = a.isFunction(this.p.beforeCollapseTreeGridNode) ? this.p.beforeCollapseTreeGridNode.call(this, d, b) : !0,
                            f = a("#" + this.p.idPrefix + a.jgrid.jqID(d), this.grid.bDiv)[0];
                        if (b[c] = !1, e === !1) return;
        ...
        searchTree: function(b) {
            var
                ...
                l = [];
            return this.each(function() {
                if (this.grid && this.p.treeGrid && i)
                    for (c = this.p.localReader.id; i--;)
                        if (j = a(this).jqGrid("getNodeAncestors", b[i], !0, !0), j.push(b[i]), d = j[0][c], -1 === a.inArray(d, k)) k.push(d), l = l.concat(j);
                        else
                            for (g = 0, e = j.length; e > g; g++) {
                                var
                                    m = !1;
        ...
        collectChildrenSortTree: function(b, c, d, e, f, g) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var
                        h, i, j, k, l, m;
                    for (k = a(this).jqGrid("getNodeChildren", c, this.p.search), l = a.jgrid.from.call(this, k), l.orderBy(d, e, f, g), m = l.select(), h = 0, i = m.length; i > h; h++) j = m[h], b.push(j), a(this).jqGrid("collectChildrenSortTree", b, j, d, e, f, g)
                }
            })
        },
                    ...
                    if (void 0 !== l) {
                        ...
                        if ("nested" === h.p.treeGridModel) {
                            if (f = a.jgrid.from.call(h, h.p.data).greater(j, d, {
                                ...
                                for (g in
                                    f) f.hasOwnProperty(g) && (f[g][j] = parseInt(f[g][j], 10) - e);
                            if (f = a.jgrid.from.call(h, h.p.data).greater(k, d, {
                                    stype: "integer"
                                }).select(), f.length)
                                for (g in
                                    f) f.hasOwnProperty(g) && (f[g][k] = parseInt(f[g][k], 10) - e)
                        }
                    }
                }
            })
                    ...
                    if (void 0 !== k) {
                        ...
                        if ("nested" === g.p.treeGridModel) {
                            if (e = a.jgrid.from(g.p.data).greater(i, c, {
                                ...
                                for (f in
                                    e) e.hasOwnProperty(f) && (e[f][i] = parseInt(e[f][i], 10) - d);
                            if (e = a.jgrid.from(g.p.data).greater(j, c, {
                                    stype: "integer"
                                }).select(), e.length)
                                for (f in
                                    e) e.hasOwnProperty(f) && (e[f][j] = parseInt(e[f][j], 10) - d)
                        }
                    }
                }
            })
                ...
                if (l = k + 1, void 0 === d[o] && (d[o] = !1), void 0 === d[u] && (d[u] = !1), d[q] = j, void 0 === d[p] && (d[p] = !0), "adjacency" === f.p.treeGridModel && (d[r] = c), "nested" === f.p.treeGridModel) {
                    ...
                    if (null !== c) {
                        if (n = parseInt(i[t], 10), z = a.jgrid.from.call(f, f.p.data), z = z.greaterOrEquals(t, n, {
                            ...
                            for (B in
                                A) A.hasOwnProperty(B) && (A[B][s] = A[B][s] > n ? parseInt(A[B][s], 10) + 2 : A[B][s], A[B][t] = A[B][t] >= n ? parseInt(A[B][t], 10) + 2 : A[B][t]);
                        d[s] = n, d[t] = n + 1
                    } else {
                        if (n = parseInt(a(f).jqGrid("getCol", t, !1, "max"), 10), A = a.jgrid.from.call(f, f.p.data).greater(s, n, {
                            ...
                            for (B in
                                A) A.hasOwnProperty(B) && (A[B][s] = parseInt(A[B][s], 10) + 2);
                        if (A = a.jgrid.from.call(f, f.p.data).greater(t, n, {
                                stype: "integer"
                            }).select(), A.length)
                            for (B in
                                A) A.hasOwnProperty(B) && (A[B][t] = parseInt(A[B][t], 10) + 2);
                        d[s] = n + 1, d[t] = n + 2
                    }
...
! function(a) {
    ...
    b(a, b) {
        var
            c, d, e, f = [];
        if (!this || "function" != typeof a || a instanceof RegExp) throw new
        TypeError;
        ...
        pivotSetup: function(c, d) {
            ...
            return this.each(function() {
                ...
                n(b, c, d, e, f) {
                    var
                        g;
                    if (a.isFunction(b)) g = b.call(this, c, d, e);
                    else
                        switch (b) {
                            case "sum":
                ...
                o(b, c, d, e) {
                    var
                        ...
                        s = [],
                        t = 1;
                    for (a.isArray(d) ? (l = d.length, s = d) : (l = 1, s[0] = d), h = [], i = [], h.root = 0, k = 0; l > k; k++) {
                        var
                            u, v = [];
                        for (g = 0; p > g; g++) {
                            if (m = "string" == typeof c[g].aggregator ? c[g].aggregator : "cust", null == d) j = a.trim(c[g].member) + "_" + m, u = j, s[0] = c[g].label || m + " " + a.trim(c[g].member);
                            else {
                                u = d[k].replace(/\s+/g, "");
                                try {
                            ...
                            j = isNaN(parseInt(j, 10)) ? j : j + " ", "avg" === c[g].aggregator && (o = -1 === r ? f.length + "_" + j : r + "_" + j, E[o] ? E[o]++ : E[o] = 1, t = E[o]), e[j] = v[j] = n(c[g].aggregator, e[j], c[g].member, b, t)
                        }
                    ...
                    for (d in
                        ...
                        if (a.hasOwnProperty(d)) {
                            if ("object" != typeof a[d]) {
                                if ("level" === d) {
                                    if (void 0 === M[a.level] && (M[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (k[a.level - 1] = {
                                            useColSpanStyle: !1,
                                            groupHeaders: []
                                        })), M[a.level] !== a.text && a.children.length && -1 === a.text.indexOf("_r_Totals") && a.level > 0) {
                                        ...
                                        if (a.level - 1 === (l.rowTotals ? 1 : 0) && h > 0) {
                                            for (var
                                                     j = 0, m = 0; h > m; m++) j += k[a.level - 1].groupHeaders[m].numberOfColumns;
                                            j && (i = j + t)
                                        }
                                        e[i] && (k[a.level - 1].groupHeaders[h].startColumnName = e[i].name, k[a.level - 1].groupHeaders[h].numberOfColumns = e.length - i), N = e.length
                                    }
                                    M[a.level] = a.text
                                }
                                if (a.level === u && "level" === d && u > 0)
                                    if (v > 1) {
                                        var
                                            n = 1;
                                        for (b in
                                            a.fields) a.fields.hasOwnProperty(b) && (1 === n && k[u - 1].groupHeaders.push({
                                            startColumnName: b,
                                            numberOfColumns: 1,
                            ...
                            if (null != a[d] && "object" == typeof a[d] && p(a[d]), "level" === d && a.level > 0 && (a.level === (0 === u ? a.level : u) || -1 !== M[a.level].indexOf("_r_Totals"))) {
                                c = 0;
                                for (b in
                                    a.fields)
                                    if (a.fields.hasOwnProperty(b)) {
                                        ...
                                        for (f in
                                            l.aggregates[c])
                                            if (l.aggregates[c].hasOwnProperty(f)) switch (f) {
                                                case "member":
                                                case "label":
                                                case "aggregator":
                                                    break;
                ...
                var
                    q, r, s, t, u, v, w, x, y = c.length,
                    z = 0;
                if (l.rowTotals && l.yDimension.length > 0) {
                    var
                        A = l.yDimension[0].dataName;
                ...
                for (var
                    ...
                    w = {}, s = 0;
                    do
                        F[s] = a.trim(q[l.xDimension[s].dataName]), w[l.xDimension[s].dataName] = F[s], s++; while (t > s);
                    var
                        H = 0;
                    if (r = -1, x = d(f, m, F)) {
                        if (r >= 0) {
                            if (H = 0, u >= 1) {
                                for (H = 0; u > H; H++) G[H] = a.trim(q[l.yDimension[H].dataName]), l.yDimension[H].converter && a.isFunction(l.yDimension[H].converter) && (G[H] = l.yDimension[H].converter.call(this, G[H], F, G));
                                x = o(q, l.aggregates, G, x)
                            } else
                                0 === u && (x = o(q, l.aggregates, null, x));
                            f[r] = x
                        }
                    } else {
                        if (H = 0, u >= 1) {
                            for (H = 0; u > H; H++) G[H] = a.trim(q[l.yDimension[H].dataName]), l.yDimension[H].converter && a.isFunction(l.yDimension[H].converter) && (G[H] = l.yDimension[H].converter.call(this, G[H], F, G));
                            w = o(q, l.aggregates, G, w)
                        } else
                            0 === u && (w = o(q, l.aggregates, null, w));
                        f.push(w)
                    }
                    var
                        I, J = 0,
                    ...
                    for (I in
                        ...
                        if (h.hasOwnProperty(I)) {
                            if (0 === J) D.children && void
                                ...
                                for (L = null, s = 0; s < K.length; s++)
                                    if (K[s].text === I) {
                                        L = K[s];
                                        break
                                    }
                                L ? K = L.children : (K.push({
                                    children: [],
                                    text: I,
                                    level: J,
                                    fields: h[I],
                ...
                if (l.colTotals)
                    for (var
                             Q = f.length; Q--;)
                        for (s = t; s < e.length; s++) P = e[s].name, g[P] ? g[P] += parseFloat(f[Q][P] || 0) : g[P] = parseFloat(f[Q][P] || 0);
                if (C > 0)
                    for (s = 0; C > s; s++) e[s].isGroupField && (j.groupingView.groupField.push(e[s].name), j.groupingView.groupSummary.push(l.groupSummary), j.groupingView.groupSummaryPos.push(l.groupSummaryPos));
                else
                    j.grouping = !1;
            ...
            return this.each(function() {
                ...
                f(b) {
                    ...
                    var
                        ...
                        k = a.assocArraySize(j.summary) > 0 ? !0 : !1,
                    ...
                    if (i = c.xDimension.length, d.sortname) {
                        for (f = d.sortorder ? d.sortorder : "asc", h = "text", e = 0; i > e; e++)
                            if (c.xDimension[e].dataName === d.sortname) {
                                h = c.xDimension[e].sorttype ? c.xDimension[e].sorttype : "text";
                                break
                            }
                        l.orderBy(d.sortname, f, h, "", h)
                    } else
                        j.groupOptions.sortname && i && (f = c.xDimension[i - 1].sortorder ? c.xDimension[i - 1].sortorder : "asc", h = c.xDimension[i - 1].sorttype ? c.xDimension[i - 1].sorttype : "text", l.orderBy(j.groupOptions.sortname, f, h, "", h));
                    ...
                    var
                        m = j.groupHeaders;
                    if (m.length)
                        for (e = 0; e < m.length; e++) m[e] && m[e].groupHeaders.length && jQuery(g).jqGrid("setGroupHeaders", m[e]);
    ...
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        saveState: function(b, c) {
            if (c = a.extend({
                ...
                var
                    ...
                    h = a("#" + b)[0];
                if (h.grid) {
                    e = a(h).data("inlineNav"), e && h.p.inlineNav && a(h).jqGrid("setGridParam", {
                        _iN: e
                    ...
                    var
                        i = g.indexOf("</tr>");
                    if (g = g.slice(i + 5), a.isFunction(c.beforeSetItem) && (d = c.beforeSetItem.call(h, f), null != d && (f = d)), c.debug) {
                    ...
                    if (c.useStorage && a.jgrid.isLocalStorage()) try {
                        ...
                        22 === n.code && alert("Local storage limit is over!")
                    }
                    return f
                }
            }
            ...
            if (d = a.extend({
                ...
                if (c) {
                    ...
                    if (e = jqGridUtils.parse(c), e && "object" === a.type(e)) {
                        ...
                        var
                            n = a("#" + b).jqGrid(e);
                        if (n.append(g), n.jqGrid("setGridParam", m), e.storeNavOptions && e.navGrid && (n[0].p.navGrid = !1, n.jqGrid("navGrid", e.pager, e.navOptions, e.editOptions, e.addOptions, e.delOptions, e.searchOptions, e.viewOptions), e.navButtons && e.navButtons.length))
                            for (var
                                     o = 0; o < e.navButtons.length; o++) "sepclass" in
                            e.navButtons[o][1] ? n.jqGrid("navSeparatorAdd", e.navButtons[o][0], e.navButtons[o][1]) : n.jqGrid("navButtonAdd", e.navButtons[o][0], e.navButtons[o][1]);
                        if (n[0].refreshIndex(), e.subGrid) {
                            var
                                p = 1 === e.multiselect ? 1 : 0,
                                q = e.rownumbers === !0 ? 1 : 0;
                            n.jqGrid("addSubGrid", p + q)
                        }
                        if (e.treeGrid)
                            for (var
                                     r = 1, s = n[0].rows.length, t = e.expColInd, u = e.treeReader.leaf_field, v = e.treeReader.expanded_field; s > r;) a(n[0].rows[r].cells[t]).find("div.treeclick").on("click", function(b) {
                                var
                                    c = b.target || b.srcElement,
                                    d = a.jgrid.stripPref(e.idPrefix, a(c, n[0].rows).closest("tr.jqgrow")[0].id),
                                    f = n[0].p._index[d];
                                return n[0].p.data[f][u] || (n[0].p.data[f][v] ? (n.jqGrid("collapseRow", n[0].p.data[f]), n.jqGrid("collapseNode", n[0].p.data[f])) : (n.jqGrid("expandRow", n[0].p.data[f]), n.jqGrid("expandNode", n[0].p.data[f]))), !1
                            }), e.ExpandColClick === !0 && a(n[0].rows[r].cells[t]).find("span.cell-wrapper").css("cursor", "pointer").on("click", function(b) {
                                var
                                    c = b.target || b.srcElement,
                                    d = a.jgrid.stripPref(e.idPrefix, a(c, n[0].rows).closest("tr.jqgrow")[0].id),
                                    f = n[0].p._index[d];
                                return n[0].p.data[f][u] || (n[0].p.data[f][v] ? (n.jqGrid("collapseRow", n[0].p.data[f]), n.jqGrid("collapseNode", n[0].p.data[f])) : (n.jqGrid("expandRow", n[0].p.data[f]), n.jqGrid("expandNode", n[0].p.data[f]))), n.jqGrid("setSelection", d), !1
                            }), r++;
                        e.multiselect && a.each(e.selarrrow, function() {
                            a("#jqg_" + b + "_" + this)[e.useProp ? "prop" : "attr"]("checked", "checked")
                        }), e.inlineNav && h && (n.jqGrid("setGridParam", {
                            inlineNav: !1
                        }), n.jqGrid("inlineNav", e.pager, h)), e.filterToolbar && i && (n.jqGrid("setGridParam", {
                            filterToolbar: !1
                        }), i.restoreFromFilters = !0, n.jqGrid("filterToolbar", i)), e.frozenColumns && n.jqGrid("setFrozenColumns"), n[0].updatepager(!0, !0), a.isFunction(d.afterSetGrid) && d.afterSetGrid(n), d.clearAfterLoad && (window[d.storageType].removeItem("jqGrid" + j.id), window[d.storageType].removeItem("jqGrid" + j.id + "_data"))
                    } else
        ...
        setRegional: function(b, c) {
            ...
            if (d = a.extend(d, c || {}), d.regional) {
                ...
                a.each(f, function(a) {
                    return this.formatter && "actions" === this.formatter ? (g = a, !1) : void
                        0
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    switch (d.rownumbers && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.multiselect && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.subGrid && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.knv = null, b.exptype) {
                        case "xmlstring":
                            c = "<" + b.root + ">" + jqGridUtils.jsonToXML(d, {
                                    xmlDecl: ""
                                }) + "</" + b.root + ">";
                            break;
                        case "jsonstring":
                            c = jqGridUtils.stringify(d), b.root && (c = "{" + b.root + ":" + c + "}")
                    }
                }
            }), c
        },
            ...
            return b = a.extend({
                ...
                if (this.grid) {
                    ...
                    if ("remote" === b.exptype) {
                        ...
                        b.exportgrouping && (d = JSON.stringify(this.p.groupingView), "string" == typeof d && (e.groupingView = d));
                        var
                            l = jQuery.param(e);
    ...
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        ...
        xmlToZip: function(b, c) {
            var
                d, e, f, g, h, i, j = this,
                k = new
                XMLSerializer, l = -1 === k.serializeToString(a.parseXML(a.jgrid.excelStrings["xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"), m = [];
            a.each(c, function(c, n) {
                if (a.isPlainObject(n)) d = b.folder(c), j.xmlToZip(d, n);
                    ...
                    if (l) {
                        ...
                        for (f = 0, g = m.length; g > f; f++) h = n.createAttribute(m[f].name.replace(":", "_dt_b_namespace_token_")), h.value = m[f].value, e.setAttributeNode(h)
                    }
            ...
            return this.each(function() {
                ...
                d(b, c) {
                    ...
                    return p.reverse(), a.each(g.groups, function(d, l) {
                        ...
                        var
                            r = "";
                        r = a.isFunction(g.groupText[l.idx]) ? g.groupText[l.idx].call(j, n, l.cnt, l.summary) : a.jgrid.template(g.groupText[l.idx], n, l.cnt, l.summary), "string" != typeof
                            r && "number" != typeof
                            r && (r = n);
                        var
                            s;
                        s = "header" === g.groupSummaryPos[l.idx] ? e(d, 0, g.groups, 0) : new
                        Array(c.collen), s[0] = a.jgrid.formatCellCsv(a.jgrid.stripHtml(r), c), f += s.join(c.separator) + c.newLine;
                        var
                            t = i - 1 === l.idx;
                        if (t) {
                            var
                                u, v, w, x = g.groups[d + 1],
                                y = 0,
                                z = l.startRow,
                                A = void
                                    0 !== x ? x.startRow : g.groups[d].startRow + g.groups[d].cnt;
                            for (u = z; A > u && b[u - y]; u++) {
                                for (w = b[u - y], o = 0, v = 0; v < k.length; v++) k[v].hidden || (s[o] = a.jgrid.formatCellCsv(a.jgrid.formatCell(w[k[v].name], v, w, k[v], j), c), o++);
                                f += s.join(c.separator) + c.newLine
                            }
                            if ("header" !== g.groupSummaryPos[l.idx]) {
                                var
                                    B;
                                if (void 0 !== x) {
                                    for (B = 0; B < g.groupField.length && x.dataIndex !== g.groupField[B]; B++);
                                    m = g.groupField.length - B
                                }
                                for (v = 0; m > v; v++) p[v] && (s = e(d, v, g.groups, 0), f += s.join(c.separator) + c.newLine);
                                m = B
                            }
                        }
                    }), f
                ...
                if (a.each(m, function(c, d) {
                        "cb" !== d.name && "rn" !== d.name || d.hidden || (v.push(c), d.hidden = !0), d.hidden || (u.push(a.jgrid.formatCellCsv(d.label || d.name, b)), w[d.name] = d.label || d.name)
                    }), b.includeLabels && (t = u.join(b.separator) + b.newLine), b.collen = u.length, j.p.grouping) p += d(k, b);
                else
                    for (; l > o;) {
                        for (f = k[o], g = [], h = 0, e = 0; n > e; e++) m[e].hidden || (g[h] = a.jgrid.formatCellCsv(a.jgrid.formatCell(f[m[e].name], e, f, m[e], j), b), h++);
                        p += g.join(b.separator) + b.newLine, o++
                    }
                if (k = null, g = new Array(b.collen), b.includeCaption && j.p.caption) {
                    for (o = b.collen; --o;) g[o] = "";
                    g[0] = a.jgrid.formatCellCsv(j.p.caption, b), q += g.join(b.separator) + b.newLine
                }
                    ...
                    for (e = 0; e < x.length; e++) {
                        ...
                        for (i in
                            ...
                            if (w.hasOwnProperty(i)) {
                                for (g[o] = "", h = 0; h < y.length; h++) y[h].startColumnName === i && (g[o] = y[h].titleText);
                                o++
                            }
                        r += g.join(b.separator) + b.newLine
                    }
                }
                if (b.includeFooter && j.p.footerrow) {
                    var
                        z = a(".ui-jqgrid-ftable", this.sDiv);
                    if (z.length) {
                        var
                            A = z[0].rows[0];
                        for (e = 0, o = 0, g = []; e < A.cells.length;) {
                            var
                                B = A.cells[e],
                                C = a(B).attr("aria-describedby").slice(-3);
                            B.hidden || "_cb" === C || "_rn" === C || (g[o] = a.jgrid.formatCellCsv(a(B).text(), b), o++), e++
                        }
                        s += g.join(b.separator) + b.newLine
                    }
                }
                for (c = q + r + t + p + s, e = 0; e < v.length; e++) m[v[e]].hidden = !1
            }), b.returnAsString ? c : void
                jqGridUtils.saveAs(c, b.fileName, {
                    type: b.mimetype
                })
        },
        exportToExcel: function(b) {
            b = a.extend(!0, {
                ...
                c(b) {
                    ...
                    d(b, d, g, h) {
                        ...
                        for (k = h; j > k; k++)
                            if (!l[k].hidden) {
                                ...
                                a.each(m.summary, function() {
                                    if (this.nm === l[k].name) {
                                        l[k].summaryTpl && (q = l[k].summaryTpl), "string" == typeof
                                            this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && n > 0 && (this.v = this.v / n));
                                        try {
                                            this.groupCount = m.cnt, this.groupIndex = m.dataIndex, this.groupValue = m.value, i = f.formatter("", this.v, k, this)
                                        } catch (b) {
                                            i = this.v
                                        }
                    ...
                    var
                        m, n = a.makeArray(g.groupSummary);
                    n.reverse(), a.each(g.groups, function(c, j) {
                        k++;
                        try {
                            m = a.isArray(g.formatDisplayField) && a.isFunction(g.formatDisplayField[j.idx]) ? g.formatDisplayField[j.idx].call(f, j.displayValue, j.value, f.p.colModel[h[j.idx]], j.idx, g) : f.formatter("", j.displayValue, h[j.idx], j.value)
                        } catch (l) {
                            m = j.displayValue
                        }
                        var
                            p = "";
                        p = a.isFunction(g.groupText[j.idx]) ? g.groupText[j.idx].call(f, m, j.cnt, j.summary) : a.jgrid.template(g.groupText[j.idx], m, j.cnt, j.summary), "string" != typeof
                            p && "number" != typeof
                            p && (p = m);
                        var
                            q;
                        q = "header" === g.groupSummaryPos[j.idx] ? d(c, 0, g.groups, 0) : e(o.header[0]);
                        var
                            s = Object.keys(q);
                        q[s[0]] = a.jgrid.stripHtml(new Array(5 * j.idx).join(" ") + p), r(q, !0);
                        var
                            t = i - 1 === j.idx;
                        if (t) {
                            var
                                ...
                                y = j.startRow,
                                z = void
                                    0 !== w ? w.startRow : g.groups[c].startRow + g.groups[c].cnt;
                            for (u = y; z > u && b[u - x]; u++) {
                                var
                                    A = b[u - x];
                                r(A, !1)
                            }
                            if ("header" !== g.groupSummaryPos[j.idx]) {
                                var
                                    B;
                                if (void 0 !== w) {
                                    for (B = 0; B < g.groupField.length && w.dataIndex !== g.groupField[B]; B++);
                                    k = g.groupField.length - B
                                }
                                for (v = 0; k > v; v++) n[v] && (q = d(c, v, g.groups, 0), r(q, !0));
                                k = B
                            }
                        }
                    })
                ...
                var
                    d, e, f = this,
                    g = a.jgrid.excelStrings,
                    h = 0,
                    i = a.parseXML(g["xl/worksheets/sheet1.xml"]),
                    j = i.getElementsByTagName("sheetData")[0],
                    k = {
                        _rels: {
                            ".rels": a.parseXML(g["_rels/.rels"])
                        },
                        xl: {
                            _rels: {
                                "workbook.xml.rels": a.parseXML(g["xl/_rels/workbook.xml.rels"])
                            },
                            "workbook.xml": a.parseXML(g["xl/workbook.xml"]),
                            "styles.xml": a.parseXML(g["xl/styles.xml"]),
                            worksheets: {
                                "sheet1.xml": i
                            }
                        },
                        "[Content_Types].xml": a.parseXML(g["[Content_Types].xml"])
                    },
                    l = f.p.colModel,
                    m = 0,
                    n = {},
                ...
                for (d = 0, e = l.length; e > d; d++) l[d].hidden || "cb" === l[d].name || "rn" === l[d].name || (n[l[d].name] = l[d].label || l[d].name, o.width[m] = 5, o.map[m] = d, m++);
                o.header.push(n);
                var
                    p, q, r = function(c, d) {
                        p = h + 1, q = a.jgrid.makeNode(i, "row", {
                            attr: {
                                r: p
                            }
                        });
                        ...
                        for (var
                            g in
                            o.header[0])
                            if (o.header[0].hasOwnProperty(g)) {
                                var
                                    k, m = a.jgrid.excelCellPos(e) + "" + p,
                                    n = c[g];
                                if (null == n && (n = ""), d || (n = "" !== n ? a.jgrid.formatCell(n, o.map[e], c, l[o.map[e]], f) : n), o.width[e] = Math.max(o.width[e], Math.min(parseInt(n.length, 10), b.maxlength)), "number" == typeof n || n.match && a.trim(n).match(/^-?\d+(\.\d+)?$/) && !a.trim(n).match(/^0\d+/)) k = a.jgrid.makeNode(i, "c", {
                                    attr: {
                                        t: "n",
                                        r: m
                                    },
                                    children: [a.jgrid.makeNode(i, "v", {
                                        text: n
                                    })]
                                });
                                else {
                                    var
                                        r = n.replace ? a.jgrid.htmlEncode(n) : n;
                                    k = a.jgrid.makeNode(i, "c", {
                                        attr: {
                                            t: "inlineStr",
                                            r: m
                                        },
                                        children: {
                                            row: a.jgrid.makeNode(i, "is", {
                                                children: {
                                                    row: a.jgrid.makeNode(i, "t", {
                                                        text: r
                                                    })
                                                }
                                            })
                ...
                if (a("sheets sheet", k.xl["workbook.xml"]).attr("name", b.sheetName), b.includeGroupHeader && f.p.groupHeader && f.p.groupHeader.length) {
                    var
                        s = f.p.groupHeader,
                        t = [],
                        u = 0;
                    for (m = 0; m < s.length; m++) {
                        ...
                        for (var
                            x in
                            o.header[0])
                            if (o.header[0].hasOwnProperty(x)) {
                                w[x] = "";
                                for (var
                                         y = 0; y < v.length; y++)
                                    if (v[y].startColumnName === x) {
                                        w[x] = v[y].titleText;
                                        var
                                            z = a.jgrid.excelCellPos(d) + u,
                                            A = a.jgrid.excelCellPos(d + v[y].numberOfColumns - 1) + u;
                                        t.push({
                                            ref: z + ":" + A
                                        })
                                    }
                    ...
                    var
                        B = a.jgrid.makeNode(i, "mergeCells", {
                            attr: {
                                count: t.length
                            }
                        });
                    for (a("worksheet", i).append(B), m = 0; m < t.length; m++) B.appendChild(a.jgrid.makeNode(i, "mergeCell", {
                        attr: t[m]
                    }))
                }
                if (b.includeLabels && (r(o.header[0], !0), a("row c", i).attr("s", "2")), f.p.grouping) c(o.body);
                else
                    for (var
                             C = 0, D = o.body.length; D > C; C++) r(o.body[C], !1);
                if (b.includeFooter || f.p.footerrow) {
                    o.footer = a(f).jqGrid("footerData", "get");
                    for (m in
                        o.footer) o.footer.hasOwnProperty(m) && (o.footer[m] = a.jgrid.stripHtml(o.footer[m]));
                    r(o.footer, !0), a("row:last c", i).attr("s", "2")
                }
                var
                    E = a.jgrid.makeNode(i, "cols");
                for (a("worksheet", i).prepend(E), m = 0, e = o.width.length; e > m; m++) E.appendChild(a.jgrid.makeNode(i, "col", {
                    attr: {
                        min: m + 1,
                        max: m + 1,
                        width: o.width[m],
                ...
                try {
                    ...
                    a.jgrid.xmlToZip(F, k), F.generateAsync ? F.generateAsync(G).then(function(a) {
                        jqGridUtils.saveAs(a, b.fileName, {
                            type: b.mimetype
                        })
                    }) : jqGridUtils.saveAs(F.generate(G), b.fileName, {
                        type: b.mimetype
                    })
                } catch (H) {
                    throw H
            ...
            return b = a.extend(!0, {
                ...
                c(b) {
                    ...
                    c(b, c) {
                        ...
                        for (var
                            f in
                            m) m.hasOwnProperty(f) && (k = {
                            text: null == b[f] ? "" : c ? a.jgrid.formatCell(b[f] + "", o[d], l[n], q[o[d]], h) : b[f],
                            alignment: r[f],
                            style: "tableBody"
                        }, e.push(k), d++);
                        return e
                    ...
                    v.reverse(), a.each(g.groups, function(d, k) {
                        ...
                        var
                            n = "";
                        n = a.isFunction(g.groupText[k.idx]) ? g.groupText[k.idx].call(h, u, k.cnt, k.summary) : a.jgrid.template(g.groupText[k.idx], u, k.cnt, k.summary), "string" != typeof
                            n && "number" != typeof
                            n && (n = u);
                        var
                            o;
                        o = "header" === g.groupSummaryPos[k.idx] ? e(d, 0, g.groups, 0) : f(m);
                        var
                            q = Object.keys(o);
                        o[q[0]] = a.jgrid.stripHtml(new Array(5 * k.idx).join(" ") + n), i.push(c(o, !1));
                        var
                            r = p - 1 === k.idx;
                        if (r) {
                            var
                            ...
                            if ("header" !== g.groupSummaryPos[k.idx]) {
                                var
                                    C;
                                if (void 0 !== x) {
                                    for (C = 0; C < g.groupField.length && x.dataIndex !== g.groupField[C]; C++);
                                    t = g.groupField.length - C
                                }
                                for (w = 0; t > w; w++) v[w] && (o = e(d, w, g.groups, 0), i.push(c(o, !1)));
                                t = C
                            }
                        }
                    })
                ...
                var
                    ...
                    q = [],
                    r = {};
                for (d = 0, e = j.length; e > d; d++) j[d].hidden || "cb" === j[d].name || "rn" === j[d].name || (k = {
                    text: j[d].label || j[d].name,
                    style: "tableHeader"
                }, p.push(k), m[j[d].name] = j[d].label || j[d].name, o[n] = d, q.push(j[d].width), r[j[d].name] = j[d].align || "left", n++);
                var
                    s;
                if (b.includeGroupHeader && h.p.groupHeader && h.p.groupHeader.length)
                    for (s = h.p.groupHeader, n = 0; n < s.length; n++) {
                        var
                            t = [],
                            u = s[n].groupHeaders;
                        for (f in
                            ...
                            if (m.hasOwnProperty(f)) {
                                for (k = {
                                    text: "",
                                    style: "tableHeader"
                                }, g = 0; g < u.length; g++) u[g].startColumnName === f && (k = {
                                    text: u[g].titleText,
                ...
                if (b.includeLabels && i.push(p), h.p.grouping) c(l);
                    ...
                    var
                        v;
                    for (n = 0, e = l.length; e > n; n++) {
                        g = 0, p = [], v = l[n];
                        for (f in
                            m) m.hasOwnProperty(f) && (k = {
                            text: null == v[f] ? "" : a.jgrid.formatCell(v[f] + "", o[g], l[n], j[o[g]], h),
                            alignment: r[f],
                            style: "tableBody"
                        }, p.push(k), g++);
                        i.push(p)
                ...
                b.description && x.content.unshift({
                    ...
                    style: "title",
                    margin: [0, 0, 0, 12]
                }), b.customSettings && b.customSettings.call(h, x);
                try {
                    var
                        y = pdfMake.createPdf(x);
                    "open" === b.download ? y.open() : y.getBuffer(function(a) {
                        jqGridUtils.saveAs(a, b.fileName, {
                            type: b.mimetype
                        })
                    })
...
! function(a) {
    ...
    return window.jqGridUtils = {
                ...
                f = function(a, b) {
                    for (var
                        ...
                        "undefined" == typeof
                            ...
                            h ? c[c.length] = g(a, h) : c[c.length] = e(a, h)
                    }
                    ...
                    for (var
                        ...
                        if (b.hasOwnProperty(j)) {
                            ...
                            j.charAt(0) !== c.attr_prefix ? null == k ? h[h.length] = "<" + j + " />" : "object" == typeof
                                ...
                                k ? h[h.length] = g(j, k) : h[h.length] = e(j, k): i[i.length] = " " + j.substring(1) + '="' + (c.encode ? d.encode(k) : k) + '"'
                        }
                    var
                        l = i.join(""),
                        m = h.join("");
                    ...
                    parseElement = function(a) {
                        if (7 !== a.nodeType) {
                            ...
                            if (a.attributes && a.attributes.length)
                                for (c = {}, d = 0; d < a.attributes.length; d++) e = a.attributes[d].nodeName, "string" == typeof
                                    e && (f = a.attributes[d].nodeValue, f && (e = o.attr_prefix + e, "undefined" == typeof g[e] && (g[e] = 0), g[e]++, addNode(c, e, g[e], f)));
                            if (a.childNodes && a.childNodes.length) {
                                var
                                    h = !0;
                                for (c && (h = !1), d = 0; d < a.childNodes.length && h; d++) {
                                    var
                                        i = a.childNodes[d].nodeType;
                                    3 !== i && 4 !== i && (h = !1)
                                }
                                if (h)
                                    ...
                                    for (c || (c = {}), d = 0; d < a.childNodes.length; d++) e = a.childNodes[d].nodeName, "string" == typeof
                                        e && (f = parseElement(a.childNodes[d]), f && ("undefined" == typeof g[e] && (g[e] = 0), g[e]++, addNode(c, e, g[e], f)))
                            }
                            return c
                        }
                    },
        ...
        saveAs: function(a, b, c) {
            ...
            h.href = e, h.download = b, document.body.appendChild(h), h.click(), setTimeout(function() {
                document.body.removeChild(h), window.URL.revokeObjectURL(e)
            }, 0)
        }
    }, window.jqGridUtils
});
                ...
                var
                    ...
                    e = {
                        ...
                        placeholder: {
                            element: function(a) {
                                var
                                    b = $(document.createElement(a[0].nodeName)).addClass(a[0].className + " ui-sortable-placeholder ui-state-highlight").removeClass("ui-sortable-helper")[0];
                                return b
                            },
                            update: function(a, b) {
        ...
        columnChooser: function(a) {
            ...
            if (!$("#colchooser_" + $.jgrid.jqID(k[0].p.id)).length) {
                ...
                a.caption && d.attr("title", a.caption), a.classname && (d.addClass(a.classname), e.addClass(a.classname)), a.width && ($(">div", d).css({
                    ...
                    return l[this.name] = a, this.hidedlg ? void(this.hidden || m.push(a)) : void
                        e.append("<option value='" + a + "' " + (this.hidden ? "" : "selected='selected'") + ">" + $.jgrid.stripHtml(o[a]) + "</option>")
                }), f = $.isFunction(a.dlog_opts) ? a.dlog_opts.call(k, a) : a.dlog_opts, c(a.dlog, d, f), g = $.isFunction(a.msel_opts) ? a.msel_opts.call(k, a) : a.msel_opts, c(a.msel, e, g), h = $("#colchooser_" + $.jgrid.jqID(k[0].p.id)), h.css({
                    margin: "auto"
                }), h.find(">div").css({
                    width: "100%",
                    height: "100%",
        ...
        gridDnD: function(a) {
            return this.each(function() {
                ...
                if (e.grid && !e.p.treeGrid && $.fn.draggable && $.fn.droppable) {
                    var
                        f = "<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>";
                    if (void 0 === $("#jqgrid_dnd")[0] && $("body").append(f), "string" == typeof a && "updateDnD" === a && e.p.jqgdnd === !0) return void
                        b();
                    var
                        g;
                    if (a = $.extend({
                            ...
                            drop: function(a) {
                                return $.extend({
                                    accept: function(a) {
                                        ...
                                        if (g = $(a).closest("table.ui-jqgrid-btable"), g.length > 0 && void 0 !== $.data(g[0], "dnd")) {
                                            var
                                                b = $.data(g[0], "dnd").connectWith;
                                            return -1 !== $.inArray("#" + $.jgrid.jqID(this.id), b) ? !0 : !1
                                        }
                                        return !1
                                    },
                                    drop: function(b, c) {
                                        if ($(c.draggable).hasClass("jqgrow")) {
                                            ...
                                            if (!a.dropbyname) {
                                                ...
                                                try {
                                                    for (h in
                                                        e) e.hasOwnProperty(h) && (f = k[i].name, "cb" !== f && "rn" !== f && "subgrid" !== f && e.hasOwnProperty(h) && k[i] && (j[f] = e[h]), i++);
                                                    e = j
                                                } catch (l) {}
                                            }
                                            if (c.helper.dropped = !0, $.data(g[0], "dnd").beforedrop && $.isFunction($.data(g[0], "dnd").beforedrop)) {
                                                var
                                                    m = $.data(g[0], "dnd").beforedrop.call(this, b, c, e, $(g[0]), $(this));
                                                void
                                            ...
                                            if (c.helper.dropped) {
                                                var
                                                    n;
                                                a.autoid && ($.isFunction(a.autoid) ? n = a.autoid.call(this, e) : (n = Math.ceil(1e3 * Math.random()), n = a.autoidprefix + n)), $("#" + $.jgrid.jqID(this.id)).jqGrid("addRowData", n, e, a.droppos)
                                            }
    ...
    a.fn.html5sortable = function(d) {
        ...
        return d = a.extend({
            ...
            if (/^enable|disable|destroy$/.test(e)) {
                var
                    f = a(this).children(a(this).data("items")).attr("draggable", "enable" === e);
                return void("destroy" === e && f.add(this).removeData("connectWith items").off("dragstart.h5s dragend.h5s selectstart.h5s dragover.h5s dragenter.h5s drop.h5s"))
            }
            var

    ...
    var fileHandler = options.fileHandler ? options.fileHandler : '/product/imagesave',
        fileDeleteHandler = options.fileDeleteHandler ? options.fileDeleteHandler : '/product/imagedestroy/0',
        fileSrc = options.fileSrc ? options.fileSrc : '/product/imagesave',
        fileCreateHandler = options.fileCreateHandler ? options.fileCreateHandler : '/product/imagecreate',
        fileMoveHandler = options.fileMoveHandler ? options.fileMoveHandler : '/product/move',
        containersUrl = options.containersUrl ? options.containersUrl : '/products/containers',
                ...
                dz = new Dropzone('#'+laradropContainer.attr('id')+' .btn-add-files', {
                    ...
                    init: function(){
                        this.on("error", function(jqXHR,textStatus,errorThrown){
                            handleError({responseText:JSON.stringify(textStatus)},textStatus,textStatus);
                        });
